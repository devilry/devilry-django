# -*- coding: utf-8 -*-
#
# Devilry documentation build configuration file, created by
...
intersphinx_mapping = {
    "django": (
        f"http://docs.djangoproject.com/en/{django_version}/",
        f"http://docs.djangoproject.com/en/{django_version}/_objects/",
    )
}
...
extlinks = {
    ...
    "devilryissue": ("https://github.com/devilry/devilry-django/issues/%s", "issue %s"),
...
project = "Devilry"
copyright = "{}, Devilry AS".format(datetime.date.today().year)
...
# Use the read the docs theme both locally and on read-the-docs.org
...
latex_documents = [
    ("index", "Devilry.tex", "Devilry Documentation", "The Devilry Team", "manual"),
]
...
man_pages = [("index", "devilry", "Devilry Documentation", ["The Devilry Team"], 1)]
