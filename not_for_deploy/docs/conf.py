...
os.environ['DJANGO_SETTINGS_MODULE'] = 'develop.settings.docs'
...
project = u'Devilry'
copyright = u'2011, The Devilry Developers'
...
latex_documents = [
  ('index', 'Devilry.tex', u'Devilry Documentation',
   u'The Devilry Team', 'manual'),
]
