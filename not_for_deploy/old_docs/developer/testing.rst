...
*******************
Model bakeryy recipes
*******************

.. currentmodule:: devilry.apps.core.baker_recipes

`Model bakeryy`_ is a great library for building Django data models
...
we have a set of model bakery recipes that that we use to create the objects that require
...
objects, but the model bakery recipes solves this in a more elegant manner.
...
***************************************
When NOT to use the model bakery recipes
***************************************
...
.. _`Model bakery`: http://model-baker.readthedocs.org
