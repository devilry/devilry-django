...
from devilry.rest.utils import force_paramtypes, HttpAccessHeaderParser, MediaRange
...
class TestParseHttpHeader(TestCase):
    def test_typeregex(self):
        regex = '^' + HttpAccessHeaderParser.type_regex + '$'
    ...
    def test_mediarangeregex(self):
        regex = '^' + HttpAccessHeaderParser.typeandsubtype_regex + '$'
    ...
    def test_paramregex(self):
        regex = '^' + HttpAccessHeaderParser.params_regex + '$'
    ...
    def test_mediarangepatt(self):
        found = HttpAccessHeaderParser.mediarange_patt.findall(
    ...
    def test_parse_content_type(self):
         self.assertEqual(HttpAccessHeaderParser.parse_content_type('text/html'), ('text', 'html'))

    def test_parse(self):
        p = HttpAccessHeaderParser()
