...
class MessageAdmin(admin.ModelAdmin):
    ...
    list_display = ["id", "status", "created_datetime", "virtual_message_receivers", "context_type"]
    search_fields = [
        "id",
        "subject",
        "created_by__id",
    ...
    exclude = ["virtual_message_receivers", "metadata", "status_data", "created_by"]
    list_filter = ["status", "context_type", "created_datetime"]
...
class MessageReceiverAdmin(admin.ModelAdmin):
    ...
    exclude = ["status_data", "metadata", "send_to", "message_type"]
    list_display = [
        "id",
        "created_datetime",
        "subject",
    ...
    search_fields = ["id", "user__id", "user__shortname", "user__fullname"]
    list_filter = ["status", "sent_datetime", "message__context_type"]
