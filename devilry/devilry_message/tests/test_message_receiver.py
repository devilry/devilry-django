...
class TestMessage(test.TestCase):
    ...
    def test_filter_old_receivers_do_not_filter_receivers_created_after_delete_datetime_sanity(self):
        ...
        delete_receivers = baker.make(
            "devilry_message.MessageReceiver", created_datetime=before_delete_created_datetime, _quantity=10
        )
        receivers = baker.make(
            "devilry_message.MessageReceiver", created_datetime=after_delete_created_datetime, _quantity=5
        )
