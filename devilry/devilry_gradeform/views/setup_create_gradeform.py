...
class CreateGradeForm(generic.TemplateView):
    ...
    def get(self, request, assignment_id):
        ...
        if not (assignment.is_admin(request.user) or request.user.is_superuser):
            return http.HttpResponseForbidden("Forbidden")

        create_setup = grade_form.AdvancedGradeForm.render_setup(grade_form.AdvancedGradeForm(), assignment)
