...
class TestZipBackend(TestCase):
    ...
    def test_path_without_tar_extension(self):
        ...
        self.assertEqual(
            posixpath.join(settings.DEVILRY_COMPRESSED_ARCHIVES_DIRECTORY, "testpath.tar.gz"), backend.archive_full_path
        )
    ...
    def test_is_compressed(self):
        ...
        mockregistry = backend_registry.MockableRegistry.make_mockregistry(backend_mock.MockDevilryZipBackend)
