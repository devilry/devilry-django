...
class TestUIPassedFailedBulkCreateView(test.TestCase, cradmin_testhelpers.TestCaseMixin):
    ...
    def test_title(self):
        testassignment = baker.make_recipe("devilry.apps.core.assignment_activeperiod_start", long_name="Assignment 0")
        examiner_user = baker.make(settings.AUTH_USER_MODEL)
        baker.make("core.Examiner", assignmentgroup__parentnode=testassignment, relatedexaminer__user=examiner_user)
        mockresponse = self.mock_http200_getrequest_htmls(cradmin_role=testassignment, requestuser=examiner_user)
        self.assertIn("Bulk create feedback", mockresponse.selector.one("title").alltext_normalized)
    ...
    def test_anonymizationmode_off_canidates(self):
        ...
        baker.make("core.Examiner", relatedexaminer__user=examineruser, assignmentgroup=testgroup)
        baker.make(
            "core.Candidate",
        ...
        mockresponse = self.mock_http200_getrequest_htmls(cradmin_role=testassignment, requestuser=examineruser)
    ...
    def test_groups_not_selected_by_default(self):
        ...
        mockresponse = self.mock_http200_getrequest_htmls(cradmin_role=testassignment, requestuser=examiner_user)
        self.assertEqual(0, mockresponse.selector.count(".cradmin-legacy-multiselect2-target-with-items"))
        self.assertEqual(0, mockresponse.selector.count(".cradmin-legacy-multiselect2-target-selected-item"))
    ...
    def test_three_groups_on_assignment(self):
        ...
        mockresponse = self.mock_http200_getrequest_htmls(cradmin_role=testassignment, requestuser=examiner_user)
        self.assertEqual(3, mockresponse.selector.count(".cradmin-legacy-multiselect2-itemvalue"))
    ...
    def test_examiner_group_access_info(self):
        ...
        self.assertEqual(
            ...
            mockresponse.selector.one(
                ".cradmin-legacy-multiselect2-itemvalue-details:nth-child(1) .devilry-user-verbose-inline-both"
            ).alltext_normalized,
        )
    ...
    def test_filter_search_two_students_one_result(self):
        ...
        mockresponse = self.mock_http200_getrequest_htmls(
            cradmin_role=testassignment, requestuser=examiner_user, viewkwargs={"filters_string": "search-Donald"}
        )
        self.assertEqual(1, mockresponse.selector.count(".cradmin-legacy-multiselect2-itemvalue"))
    ...
    def test_filter_search_three_students_two_results(self):
        ...
        mockresponse = self.mock_http200_getrequest_htmls(
            cradmin_role=testassignment, requestuser=examiner_user, viewkwargs={"filters_string": "search-Don"}
        )
        self.assertEqual(2, mockresponse.selector.count(".cradmin-legacy-multiselect2-itemvalue"))
        element_lst = mockresponse.selector.list(
            ".cradmin-legacy-multiselect2-itemvalue-details:nth-child(1) .devilry-user-verbose-inline-both"
        )
        ...
        self.assertIn("{}({})".format(donald_user.fullname, donald_user.shortname), element_lst)
        self.assertIn("{}({})".format(don_user.fullname, don_user.shortname), element_lst)
        self.assertNotIn("{}({})".format(april_user.fullname, april_user.shortname), element_lst)
...
class TestPassedFailedBulkCreateFeedback(test.TestCase, cradmin_testhelpers.TestCaseMixin):
    ...
    def test_success_message(self):
        ...
        self.mock_postrequest(
            ...
            requestkwargs={
                "data": {"passed": True, "feedback_comment_text": "feedback comment", "selected_items": [testgroup1.id]}
            },
            messagesmock=messagemock,
        )

        messagemock.add.assert_called_once_with(
            messages.SUCCESS, "Bulk added feedback for {}".format(testgroup1.short_displayname), ""
        )
    ...
    def test_only_bulk_create_passed_group_ids(self):
        ...
        # create FeedbackSets for the AssignmentGroups
        testfeedbackset_first_attempt = devilry_group_baker_factories.feedbackset_first_attempt_published(
            group=testgroup1
        )
        testfeedbackset_new_attempt = devilry_group_baker_factories.feedbackset_new_attempt_unpublished(
            group=testgroup1
        )
        devilry_group_baker_factories.feedbackset_new_attempt_unpublished(group=testgroup2)
    ...
    def test_group_receives_bulk_feedback(self):
        ...
        testfeedbackset_new_attempt = devilry_group_baker_factories.feedbackset_new_attempt_unpublished(group=testgroup)

        self.mock_postrequest(
            cradmin_role=testassignment,
            requestuser=examiner_user,
            requestkwargs={
                "data": {"passed": True, "feedback_comment_text": "feedback comment", "selected_items": [testgroup.id]}
            },
        )
        ...
        self.assertEqual(testassignment.passing_grade_min_points, cached_data.last_published_feedbackset.grading_points)
    ...
    def test_multiple_groups_receive_bulk_feedback(self):
        ...
        testfeedbackset_group3 = devilry_group_baker_factories.feedbackset_first_attempt_unpublished(group=testgroup3)
    ...
    def test_get_num_queries(self):
        ...
        devilry_group_baker_factories.feedbackset_first_attempt_unpublished(group=testgroup2)
        devilry_group_baker_factories.feedbackset_first_attempt_unpublished(group=testgroup3)
        devilry_group_baker_factories.feedbackset_first_attempt_unpublished(group=testgroup4)
        devilry_group_baker_factories.feedbackset_first_attempt_unpublished(group=testgroup5)

        with self.assertNumQueries(5):
            self.mock_http200_getrequest_htmls(cradmin_role=testassignment, requestuser=examiner_user)
...
class TestPointsBulkCreateFeedback(test.TestCase, cradmin_testhelpers.TestCaseMixin):
    ...
    def test_only_bulk_create_passed_group_ids(self):
        ...
        self.mock_postrequest(
            ...
            requestuser=examiner_user,
            requestkwargs={
                "data": {"points": 10, "feedback_comment_text": "feedback comment", "selected_items": [testgroup1.id]}
            },
        )
    ...
    def test_group_receives_bulk_feedback(self):
        ...
        self.mock_postrequest(
            ...
            requestuser=examiner_user,
            requestkwargs={
                "data": {"points": 10, "feedback_comment_text": "feedback comment", "selected_items": [testgroup.id]}
            },
        )
    ...
    def test_get_num_queries(self):
        ...
        devilry_group_baker_factories.feedbackset_first_attempt_unpublished(group=testgroup4)
        devilry_group_baker_factories.feedbackset_first_attempt_unpublished(group=testgroup5)
        devilry_group_baker_factories.feedbackset_first_attempt_unpublished(group=testgroup6)
