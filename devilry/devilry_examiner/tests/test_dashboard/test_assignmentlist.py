...
class TestAssignmentListView(test.TestCase, cradmin_testhelpers.TestCaseMixin):
    ...
    def test_title(self):
        ...
        mockresponse = self.mock_http200_getrequest_htmls(cradmin_role=testuser, requestuser=testuser)
        self.assertIn("Examiner dashboard", mockresponse.selector.one("title").alltext_normalized)

    def test_h1(self):
        testuser = baker.make(settings.AUTH_USER_MODEL)
        baker.make("core.Examiner", relatedexaminer__user=testuser)
        mockresponse = self.mock_http200_getrequest_htmls(cradmin_role=testuser, requestuser=testuser)
        self.assertEqual("Examiner dashboard", mockresponse.selector.one("h1").alltext_normalized)
    ...
    def test_render_search_nomatch(self):
        ...
        mockresponse = self.mock_http200_getrequest_htmls(
            cradmin_role=testuser, viewkwargs={"filters_string": "search-nomatch"}, requestuser=testuser
        )
        self.assertEqual(0, mockresponse.selector.count(".cradmin-legacy-listbuilder-itemvalue-titledescription-title"))
    ...
    def test_render_search_match_subject_short_name(self):
        ...
        mockresponse = self.mock_http200_getrequest_htmls(
            cradmin_role=testuser, viewkwargs={"filters_string": "search-testsubject"}, requestuser=testuser
        )
        self.assertEqual(1, mockresponse.selector.count(".cradmin-legacy-listbuilder-itemvalue-titledescription-title"))
    ...
    def test_render_search_match_period_short_name(self):
        ...
        mockresponse = self.mock_http200_getrequest_htmls(
            cradmin_role=testuser, viewkwargs={"filters_string": "search-testperiod"}, requestuser=testuser
        )
        self.assertEqual(1, mockresponse.selector.count(".cradmin-legacy-listbuilder-itemvalue-titledescription-title"))
    ...
    def test_render_search_match_assignment_short_name(self):
        ...
        mockresponse = self.mock_http200_getrequest_htmls(
            cradmin_role=testuser, viewkwargs={"filters_string": "search-testassignment"}, requestuser=testuser
        )
        self.assertEqual(1, mockresponse.selector.count(".cradmin-legacy-listbuilder-itemvalue-titledescription-title"))
    ...
    def test_render_orderby_name_ascending(self):
        ...
        baker.make(
            ...
            relatedexaminer__user=testuser,
            assignmentgroup__parentnode=baker.make_recipe(
                "devilry.apps.core.assignment_activeperiod_start", long_name="Assignment 1", parentnode=testperiod1
            ),
        )
        baker.make(
            "core.Examiner",
            relatedexaminer__user=testuser,
            assignmentgroup__parentnode=baker.make_recipe(
                "devilry.apps.core.assignment_activeperiod_start", long_name="Assignment 1", parentnode=testperiod2
            ),
        )
        baker.make(
            "core.Examiner",
            relatedexaminer__user=testuser,
            assignmentgroup__parentnode=baker.make_recipe(
                "devilry.apps.core.assignment_activeperiod_start", long_name="Assignment 2", parentnode=testperiod1
            ),
        )
        mockresponse = self.mock_http200_getrequest_htmls(
            cradmin_role=testuser, requestuser=testuser, viewkwargs={"filters_string": "orderby-name_ascending"}
        )
        self.assertEqual(
            [
                "testsubject1.testperiod - Assignment 1",
    ...
    def test_render_orderby_name_descending(self):
        ...
        mockresponse = self.mock_http200_getrequest_htmls(
            cradmin_role=testuser, requestuser=testuser, viewkwargs={"filters_string": "orderby-name_descending"}
        )
        self.assertEqual(
            [
                "testsubject2.testperiod - Assignment 1",
    ...
    def test_selfassign_user_not_related_examiner_on_period_sanity(self):
        ...
        mockresponse = self.mock_http200_getrequest_htmls(cradmin_role=examiner_user, requestuser=examiner_user)
