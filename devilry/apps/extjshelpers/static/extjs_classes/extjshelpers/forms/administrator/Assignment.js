Ext.define('devilry.extjshelpers.forms.administrator.Assignment', {
    ...
    help: [
        ...
        'If set <strong>anonymous</strong> to <em>yes</em>, examiners see a <em>candidate-id</em> instead of a username. A candidate-id must be set for each student.' //Normally students can see who their examiner is, however when <em>anonymous</em> is checked students do not get any information about their examiner(s).'
    ]
});
