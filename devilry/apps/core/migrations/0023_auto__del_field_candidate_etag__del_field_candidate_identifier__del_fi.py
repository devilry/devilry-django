...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Candidate.etag'
        db.delete_column(u'core_candidate', 'etag')

        # Deleting field 'Candidate.identifier'
        db.delete_column(u'core_candidate', 'identifier')

        # Deleting field 'Candidate.email'
        db.delete_column(u'core_candidate', 'email')

        # Deleting field 'Candidate.full_name'
        db.delete_column(u'core_candidate', 'full_name')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Candidate.etag'
        raise RuntimeError("Cannot reverse this migration. 'Candidate.etag' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Candidate.etag'
        db.add_column(u'core_candidate', 'etag',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Candidate.identifier'
        raise RuntimeError("Cannot reverse this migration. 'Candidate.identifier' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Candidate.identifier'
        db.add_column(u'core_candidate', 'identifier',
                      self.gf('django.db.models.fields.CharField')(max_length=30),
                      keep_default=False)

        # Adding field 'Candidate.email'
        db.add_column(u'core_candidate', 'email',
                      self.gf('django.db.models.fields.CharField')(max_length=300, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Candidate.full_name'
        db.add_column(u'core_candidate', 'full_name',
                      self.gf('django.db.models.fields.CharField')(max_length=300, null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'core.groupinvite': {
            ...
            'sent_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'groupinvite_sent_by_set'", 'to': u"orm['auth.User']"}),
            'sent_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'sent_to': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'groupinvite_sent_to_set'", 'to': u"orm['auth.User']"})
        },
        'core.node': {
        ...
        'core.relatedstudentkeyvalue': {
            ...
            'student_can_read': ('django.db.models.fields.BooleanField', [], {}),
            'value': ('django.db.models.fields.TextField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'})
        },
        'core.staticfeedback': {
