...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('core_groupinvite', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.AssignmentGroup'])),
            ('sent_datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('sent_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='groupinvite_sent_by_set', to=orm['auth.User'])),
            ('sent_to', self.gf('django.db.models.fields.related.ForeignKey')(related_name='groupinvite_sent_to_set', to=orm['auth.User'])),
            ('accepted', self.gf('django.db.models.fields.NullBooleanField')(default=None, null=True, blank=True)),
            ('responded_datetime', self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True)),
        ))
        db.send_create_signal('core', ['GroupInvite'])


    def backwards(self, orm):
        # Deleting model 'GroupInvite'
        db.delete_table('core_groupinvite')
