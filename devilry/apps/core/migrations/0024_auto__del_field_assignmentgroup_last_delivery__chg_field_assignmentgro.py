...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AssignmentGroup.last_delivery'
        db.delete_column(u'core_assignmentgroup', 'last_delivery_id')


        # Changing field 'AssignmentGroup.feedback'
        db.alter_column(u'core_assignmentgroup', 'feedback_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['core.StaticFeedback'], unique=True, null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):
        # Adding field 'AssignmentGroup.last_delivery'
        db.add_column(u'core_assignmentgroup', 'last_delivery',
                      self.gf('django.db.models.fields.related.OneToOneField')(related_name='last_delivery_by_group', null=True, on_delete=models.SET_NULL, to=orm['core.Delivery'], blank=True, unique=True),
                      keep_default=False)


        # Changing field 'AssignmentGroup.feedback'
        db.alter_column(u'core_assignmentgroup', 'feedback_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['core.StaticFeedback'], unique=True, null=True))
