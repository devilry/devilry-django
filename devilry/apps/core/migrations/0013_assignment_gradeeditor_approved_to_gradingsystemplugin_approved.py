...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        orm.Assignment.objects.filter(gradeeditor_config__gradeeditorid='approved').update(
            max_points=1, passing_grade_min_points=1,
    ...
    models = {
        ...
        'core.assignmentgroup': {
            ...
            'last_deadline': ('django.db.models.fields.related.OneToOneField', [], {'blank': 'True', 'related_name': "'last_deadline_for_group'", 'unique': 'True', 'null': 'True', 'to': "orm['core.Deadline']"}),
            'last_delivery': ('django.db.models.fields.related.OneToOneField', [], {'blank': 'True', 'related_name': "'last_delivery_by_group'", 'unique': 'True', 'null': 'True', 'to': "orm['core.Delivery']"}),
        ...
        'gradeeditors.config': {
            ...
            'assignment': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'gradeeditor_config'", 'unique': 'True', 'primary_key': 'True', 'to': "orm['core.Assignment']"}),
            'config': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'gradeeditorid': ('django.db.models.fields.SlugField', [], {'max_length': '50'})
        },
        'gradeeditors.feedbackdraft': {
            'Meta': {'object_name': 'FeedbackDraft'},
            ...
            'saved_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'staticfeedback': ('django.db.models.fields.related.OneToOneField', [], {'blank': 'True', 'related_name': "'gradeeditor_feedbackdraft'", 'unique': 'True', 'null': 'True', 'to': "orm['core.StaticFeedback']"})
        }
    }

    complete_apps = ['gradeeditors', 'core']
    symmetrical = True
