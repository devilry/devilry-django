    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('period', models.ForeignKey(verbose_name='Period', to='core.Period', help_text='The period.')),
                ('user', models.ForeignKey(help_text='The related user.', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('saved_by', models.ForeignKey(help_text='The user (examiner) who saved this feedback', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.AddField(
            model_name='period',
            name='parentnode',
            field=models.ForeignKey(related_name='periods', verbose_name='Subject', to='core.Subject'),
        ),
        migrations.AddField(
            model_name='delivery',
            name='last_feedback',
        ...
        migrations.AddField(
            ...
            name='parentnode',
            field=models.ForeignKey(related_name='assignments', verbose_name='Period', to='core.Period'),
        ),
