...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Assignment.max_points'
        db.alter_column('core_assignment', 'max_points', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'Assignment.passing_grade_min_points'
        db.alter_column('core_assignment', 'passing_grade_min_points', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'PointRangeToGrade.minimum_points'
        db.alter_column('core_pointrangetograde', 'minimum_points', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'PointRangeToGrade.maximum_points'
        db.alter_column('core_pointrangetograde', 'maximum_points', self.gf('django.db.models.fields.PositiveIntegerField')())

    def backwards(self, orm):

        # Changing field 'Assignment.max_points'
        db.alter_column('core_assignment', 'max_points', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Assignment.passing_grade_min_points'
        db.alter_column('core_assignment', 'passing_grade_min_points', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'PointRangeToGrade.minimum_points'
        db.alter_column('core_pointrangetograde', 'minimum_points', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'PointRangeToGrade.maximum_points'
        db.alter_column('core_pointrangetograde', 'maximum_points', self.gf('django.db.models.fields.IntegerField')())
