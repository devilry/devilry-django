...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StaticFeedbackFileAttachment'
        db.create_table(u'core_staticfeedbackfileattachment', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('staticfeedback', self.gf('django.db.models.fields.related.ForeignKey')(related_name='files', to=orm['core.StaticFeedback'])),
            ('filename', self.gf('django.db.models.fields.TextField')()),
            ('file', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
        ))
        db.send_create_signal('core', ['StaticFeedbackFileAttachment'])


    def backwards(self, orm):
        # Deleting model 'StaticFeedbackFileAttachment'
        db.delete_table(u'core_staticfeedbackfileattachment')
    ...
    models = {
        ...
        'core.staticfeedbackfileattachment': {
            'Meta': {'object_name': 'StaticFeedbackFileAttachment'},
            'file': ('django.db.models.fields.files.FileField', [], {'max_length': '100'}),
            'filename': ('django.db.models.fields.TextField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'staticfeedback': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'files'", 'to': "orm['core.StaticFeedback']"})
        },
        'core.subject': {
