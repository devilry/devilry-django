...
def devilry_multiple_candidates_long_displayname(assignment, candidates):
    """
...
def devilry_multiple_candidates_short_displayname(assignment, candidates):
    """
    Returns the candidates wrapped in HTML formatting tags perfect for showing
...
def devilry_multiple_examiners_long_displayname(assignment, examiners):
    """
