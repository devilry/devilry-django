...
class TestPointToGradeMapQuerySetPrefetchPointrangeToGrade(TestCase):
    def test_no_pointtograde(self):
        ...
        prefetched_point_to_grade_map = PointToGradeMap.objects.prefetch_pointrange_to_grade().get(
            id=point_to_grade_map.id
        )
    ...
    def test_has_pointtograde(self):
        ...
        self.assertEqual([pointrangetograde], prefetched_point_to_grade_map.prefetched_pointrangetograde_objects)

    def test_ordering(self):
        point_to_grade_map = baker.make("core.PointToGradeMap")
        pointrangetograde2 = baker.make(
            "core.PointRangeToGrade", point_to_grade_map=point_to_grade_map, minimum_points=10
        )
        pointrangetograde1 = baker.make(
            "core.PointRangeToGrade", point_to_grade_map=point_to_grade_map, minimum_points=0
        )
        pointrangetograde3 = baker.make(
            "core.PointRangeToGrade", point_to_grade_map=point_to_grade_map, minimum_points=20
        )
        prefetched_point_to_grade_map = PointToGradeMap.objects.prefetch_pointrange_to_grade().get(
            id=point_to_grade_map.id
        )
        self.assertEqual(
            [pointrangetograde1, pointrangetograde2, pointrangetograde3],
...
class TestPointRangeToGradeManager(TestCase):
    def setUp(self):
        self.assignment = PeriodBuilder.quickadd_ducku_duck1010_active().add_assignment("assignment").assignment
        self.point_to_grade_map = PointToGradeMap.objects.create(assignment=self.assignment)

    def test_filter_overlapping_ranges(self):
        self.point_to_grade_map.pointrangetograde_set.create(minimum_points=10, maximum_points=20, grade="D")
    ...
    def test_filter_grades_matching_points(self):
        self.point_to_grade_map.pointrangetograde_set.create(minimum_points=0, maximum_points=9, grade="F")
        self.point_to_grade_map.pointrangetograde_set.create(minimum_points=10, maximum_points=20, grade="E")
        self.point_to_grade_map.pointrangetograde_set.create(minimum_points=21, maximum_points=30, grade="D")
...
class TestPointRangeToGrade(TestCase):
    def setUp(self):
        ...
        self.assignment = self.periodbuilder.add_assignment("assignment", max_points=100).assignment
    ...
    def test_clean_overlapping_other_on_same_assignment_fails(self):
        point_to_grade_map = PointToGradeMap.objects.create(assignment=self.assignment)
        point_to_grade_map.pointrangetograde_set.create(minimum_points=10, maximum_points=20, grade="D")
        pointrange_to_grade = PointRangeToGrade(
            point_to_grade_map=point_to_grade_map, minimum_points=12, maximum_points=18, grade="C"
        )
        with self.assertRaises(ValidationError):
            pointrange_to_grade.clean()
    ...
    def test_clean_does_not_match_overlapping_range_in_other_assignments(self):
        assignment2 = self.periodbuilder.add_assignment("assignment2", max_points=100).assignment
        pointrange_to_grade = PointRangeToGrade(
            point_to_grade_map=PointToGradeMap.objects.create(assignment=self.assignment),
            minimum_points=12,
            maximum_points=18,
    ...
    def test_clean_not_unique_grade(self):
        point_to_grade_map = PointToGradeMap.objects.create(assignment=self.assignment)
        PointRangeToGrade(point_to_grade_map=point_to_grade_map, minimum_points=1, maximum_points=2, grade="C").save()
        pointrange_to_grade = PointRangeToGrade(
            point_to_grade_map=point_to_grade_map, minimum_points=5, maximum_points=6, grade="C"
        )
    ...
    def test_ordering(self):
        point_to_grade_map = PointToGradeMap.objects.create(assignment=self.assignment)
        f = point_to_grade_map.pointrangetograde_set.create(minimum_points=0, maximum_points=20, grade="F")
        e = point_to_grade_map.pointrangetograde_set.create(minimum_points=21, maximum_points=40, grade="E")
        d = point_to_grade_map.pointrangetograde_set.create(minimum_points=41, maximum_points=50, grade="D")
...
class TestPointToGradeMapOldTests(TestCase):
    ...
    def test_points_to_grade_multi_assignment(self):
        ...
        point_to_grade_map1.pointrangetograde_set.create(minimum_points=0, maximum_points=9, grade="F")
        ...
        pointrange_to_grade2 = point_to_grade_map2.pointrangetograde_set.create(
            minimum_points=0, maximum_points=3, grade="F"
        )
    ...
    def test_clean_single_entry_valid(self):
        point_to_grade_map = PointToGradeMap.objects.create(assignment=self.assignment)
        point_to_grade_map.pointrangetograde_set.create(minimum_points=0, maximum_points=100, grade="Good")
        self.assertTrue(point_to_grade_map.invalid)
        point_to_grade_map.clean()
    ...
    def test_clean_multientry_valid(self):
        point_to_grade_map = PointToGradeMap.objects.create(assignment=self.assignment)
        point_to_grade_map.pointrangetograde_set.create(minimum_points=0, maximum_points=30, grade="Bad")
        point_to_grade_map.pointrangetograde_set.create(minimum_points=31, maximum_points=70, grade="Better")
        point_to_grade_map.pointrangetograde_set.create(minimum_points=71, maximum_points=100, grade="Good")
        self.assertTrue(point_to_grade_map.invalid)
        point_to_grade_map.clean()
        self.assertFalse(point_to_grade_map.invalid)
    ...
    def test_clean_invalid_first_minimum_points(self):
        point_to_grade_map = PointToGradeMap.objects.create(assignment=self.assignment)
        point_to_grade_map.pointrangetograde_set.create(minimum_points=1, maximum_points=30, grade="Bad")
        point_to_grade_map.pointrangetograde_set.create(minimum_points=31, maximum_points=100, grade="Better")
        self.assertTrue(point_to_grade_map.invalid)
    ...
    def test_clean_invalid_gaps_in_map(self):
        point_to_grade_map = PointToGradeMap.objects.create(assignment=self.assignment)
        point_to_grade_map.pointrangetograde_set.create(minimum_points=0, maximum_points=30, grade="Bad")
        point_to_grade_map.pointrangetograde_set.create(minimum_points=32, maximum_points=100, grade="Better")
        self.assertTrue(point_to_grade_map.invalid)
    ...
    def test_create_map(self):
        point_to_grade_map = PointToGradeMap.objects.create(assignment=self.assignment)
        point_to_grade_map.create_map((0, "Bad"), (30, "Better"), (60, "Good"))
...
class TestPointToGradeMap(TestCase):
    ...
    def test_prefetched_pointrangetogrades_property_is_prefetched(self):
        ...
        self.assertEqual([pointrangetograde], prefetched_point_to_grade_map.prefetched_pointrangetogrades)
    ...
    def test_as_choices(self):
        ...
        point_to_grade_map = PointToGradeMap.objects.prefetch_pointrange_to_grade().get(id=point_to_grade_map.id)
        self.assertEqual(
            point_to_grade_map.as_choices(),
            [
                (0, "Bad"),
                (3, "Medium"),
                (7, "Good"),
