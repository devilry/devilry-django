...
class TestGroupUserLookupViewroleStudent(test.TestCase):
    ...
    def test_user_role_admin_get_unanonymized_longname(self):
        ...
        test_adminuser = baker.make(settings.AUTH_USER_MODEL, fullname="Test Admin", shortname="testadmin@example.com")
        group_user_lookup = GroupUserLookup(
            assignment=testassignment, group=testgroup, requestuser=testuser, requestuser_devilryrole=self.viewrole
        )
        self.assertEqual(
            group_user_lookup.get_long_name_from_user(user=test_adminuser, user_role="admin"),
    ...
    def test_user_role_examiner_get_unanonymized_longname(self):
        ...
        testgroup = baker.make("core.AssignmentGroup", parentnode=testassignment)
        testuser = baker.make(settings.AUTH_USER_MODEL)
        test_examineruser = baker.make(
            settings.AUTH_USER_MODEL, fullname="Test Examiner", shortname="testexaminer@example.com"
        )
        ...
        self.assertEqual(
            group_user_lookup.get_long_name_from_user(user=test_examineruser, user_role="examiner"),
    ...
    def test_user_role_examiner_user_is_examiner_and_student_is_not_anonymized_to_themselves(self):
        ...
        testgroup = baker.make("core.AssignmentGroup", parentnode=testassignment)
        testuser = baker.make(settings.AUTH_USER_MODEL, fullname="Test Examiner", shortname="testexaminer@example.com")
        baker.make(
            "core.RelatedExaminer",
            user=testuser,
            period=testassignment.parentnode,
        ...
        self.assertEqual(
            group_user_lookup.get_long_name_from_user(user=testuser, user_role="examiner"),
            "Test Examiner (testexaminer@example.com)",
        )
    ...
    def test_user_role_student_get_unanonymized_longname(self):
        ...
        testgroup = baker.make("core.AssignmentGroup", parentnode=testassignment)
        testuser = baker.make(settings.AUTH_USER_MODEL)
        test_studentuser = baker.make(
            settings.AUTH_USER_MODEL, fullname="Test Student", shortname="teststudent@example.com"
        )
        baker.make(
            "core.Candidate",
        ...
        self.assertEqual(
            group_user_lookup.get_long_name_from_user(user=test_studentuser, user_role="student"),
...
class TestGroupUserLookupViewroleExaminer(test.TestCase):
    ...
    def test_user_role_student_get_anonymized_longname_for_assignment_uses_custom_candidate_ids(self):
        ...
        self.assertEqual(group_user_lookup.get_long_name_from_user(user=test_studentuser, user_role="student"), "1234")
    ...
    def test_user_role_student_get_anonymized_longname(self):
        ...
        self.assertEqual(
            group_user_lookup.get_long_name_from_user(user=test_studentuser, user_role="student"), "Some anonymous name"
        )
    ...
    def test_user_role_student_user_is_student_and_examiner_is_not_anonymized_to_themselves(self):
        ...
        testgroup = baker.make("core.AssignmentGroup", parentnode=testassignment)
        testuser = baker.make(settings.AUTH_USER_MODEL, fullname="Test Student", shortname="teststudent@example.com")
        baker.make(
            "core.Candidate",
            assignment_group=testgroup,
        ...
        self.assertEqual(
            group_user_lookup.get_long_name_from_user(user=testuser, user_role="student"),
            "Test Student (teststudent@example.com)",
        )
