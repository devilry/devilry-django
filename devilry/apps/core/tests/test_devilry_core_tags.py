...
class TestDevilrySingleCandidateLongDisplayname(test.TestCase):
    def test_nonanonymous_cssclass(self):
        ...
        candidate = baker.make(
            "core.Candidate", assignment_group__parentnode=assignment, relatedstudent__user__shortname="testuser"
        )
        selector = htmls.S(
            render_to_string(
    ...
    def test_nonanonymous_with_fullname(self):
        ...
        self.assertEqual("Test User(testuser)", selector.one(".devilry-user-verbose-inline").alltext_normalized)
    ...
    def test_anonymous(self):
        ...
        self.assertEqual("MyAnonymousId", selector.one(".devilry-core-candidate-anonymous-name").alltext_normalized)
...
class TestDevilrySingleCandidateShortDisplayname(test.TestCase):
    ...
    def test_nonanonymous_without_fullname(self):
        ...
        self.assertEqual("testuser", selector.one(".devilry-core-candidate-shortname").alltext_normalized)
...
class TestDevilrySingleExaminerLongDisplayname(test.TestCase):
    def test_nonanonymous_cssclass(self):
        assignment = baker.make("core.Assignment")
        examiner = baker.make(
            "core.Examiner", assignmentgroup__parentnode=assignment, relatedexaminer__user__shortname="testuser"
        )
        selector = htmls.S(
            render_to_string(
    ...
    def test_anonymous(self):
        ...
        self.assertEqual("MyAnonymousId", selector.one(".devilry-core-examiner-anonymous-name").alltext_normalized)
...
class TestDevilrySingleExaminerShortDisplayname(test.TestCase):
    ...
    def test_nonanonymous_without_fullname(self):
        ...
        self.assertEqual("testuser", selector.one(".devilry-core-examiner-shortname").alltext_normalized)
...
class TestDevilryMultipleCandidatesLongDisplayname(test.TestCase):
    ...
    def test_empty(self):
        ...
        self.assertEqual(
            "no students in group", selector.one(".devilry-core-no-candidates-in-group").alltext_normalized
        )
        self.assertFalse(selector.exists(".devilry-user-verbose-inline"))
        self.assertFalse(selector.exists(".devilry-core-candidate-anonymous-name"))
    ...
    def test_nonanonymous_multiple_candidates(self):
        ...
        candidate1 = baker.make(
            "core.Candidate", assignment_group__parentnode=assignment, relatedstudent__user__shortname="testuser1"
        )
        candidate2 = baker.make(
            "core.Candidate",
            assignment_group__parentnode=assignment,
        ...
        names = [element.alltext_normalized for element in selector.list(".devilry-user-verbose-inline")]
    ...
    def test_anonymous_multiple_candidates(self):
        ...
        names = [element.alltext_normalized for element in selector.list(".devilry-core-candidate-anonymous-name")]
...
class TestDevilryMultipleCandidatesShortDisplayname(test.TestCase):
    ...
    def test_nonanonymous_multiple_candidates(self):
        ...
        names = [element.alltext_normalized for element in selector.list(".devilry-core-candidate-shortname")]
...
class TestDevilryMultipleExaminersLongDisplayname(test.TestCase):
    ...
    def test_empty(self):
        ...
        self.assertEqual("no examiner(s)", selector.one(".devilry-core-no-examiners-for-group").alltext_normalized)
        self.assertFalse(selector.exists(".devilry-user-verbose-inline"))
        self.assertFalse(selector.exists(".devilry-core-examiner-anonymous-name"))
    ...
    def test_nonanonymous_multiple_examiners(self):
        assignment = baker.make("core.Assignment")
        examiner1 = baker.make(
            "core.Examiner", assignment_group__parentnode=assignment, relatedexaminer__user__shortname="testuser1"
        )
        examiner2 = baker.make(
            "core.Examiner",
            assignment_group__parentnode=assignment,
    ...
    def test_anonymous_multiple_examiners(self):
        ...
        names = [element.alltext_normalized for element in selector.list(".devilry-core-examiner-anonymous-name")]
        self.assertEqual(["MyAnonymousId1", "MyAnonymousId2"], names)
...
class TestDevilryMultipleExaminersShortDisplayname(test.TestCase):
    ...
    def test_nonanonymous_multiple_examiners(self):
        ...
        names = [element.alltext_normalized for element in selector.list(".devilry-core-examiner-shortname")]
        self.assertEqual(["testuser1", "testuser2"], names)
...
class MockGroupStatusGroup(object):
    def __init__(self, is_corrected=False, is_waiting_for_feedback=False, is_waiting_for_deliveries=False):
...
class TestDevilryGroupstatus(test.TestCase):
    def test_is_corrected(self):
        ...
        self.assertEqual("corrected", selector.one(".devilry-core-groupstatus-corrected").alltext_normalized)
    ...
    def test_is_waiting_for_feedback(self):
        ...
        self.assertFalse(selector.exists(".devilry-core-groupstatus-deliveries"))
        self.assertTrue(
            "waiting for feedback", selector.one(".devilry-core-groupstatus-waiting-for-feedback").alltext_normalized
        )
...
class TestDevilryGradeShort(test.TestCase):
    def test_failed(self):
        ...
        self.assertTrue(selector.exists(".devilry-core-grade-short.devilry-core-grade-failed"))
    ...
    def test_passed(self):
        ...
        self.assertTrue(selector.exists(".devilry-core-grade-short.devilry-core-grade-passed"))

    def test_passed_failed_failed(self):
        testassignment = baker.make(
            "core.Assignment", points_to_grade_mapper=Assignment.POINTS_TO_GRADE_MAPPER_PASSED_FAILED
        )
        selector = htmls.S(
            render_to_string(
                "devilry_core/templatetags/grade-short.django.html",
        ...
        self.assertTrue(
            selector.exists(".devilry-core-grade-short.devilry-core-grade.devilry-core-grade-mapper-passed-failed")
        )
        self.assertEqual("failed", selector.one(".devilry-core-grade").alltext_normalized)
    ...
    def test_passed_failed_passed(self):
        ...
        self.assertEqual("passed", selector.one(".devilry-core-grade").alltext_normalized)

    def test_raw_points(self):
        testassignment = baker.make(
            "core.Assignment", points_to_grade_mapper=Assignment.POINTS_TO_GRADE_MAPPER_RAW_POINTS, max_points=100
        )
        selector = htmls.S(
            render_to_string(
                "devilry_core/templatetags/grade-short.django.html",
        ...
        self.assertTrue(
            selector.exists(".devilry-core-grade-short.devilry-core-grade.devilry-core-grade-mapper-raw-points")
        )
        self.assertEqual("10/100", selector.one(".devilry-core-grade").alltext_normalized)

    def test_custom_table(self):
        testassignment = baker.make(
            "core.Assignment", points_to_grade_mapper=Assignment.POINTS_TO_GRADE_MAPPER_CUSTOM_TABLE
        )
        ...
        self.assertTrue(
            selector.exists(".devilry-core-grade-short.devilry-core-grade.devilry-core-grade-mapper-custom-table")
        )
        self.assertEqual("Bad", selector.one(".devilry-core-grade").alltext_normalized)
...
class TestDevilryGradeFull(test.TestCase):
    def test_failed(self):
        ...
        self.assertTrue(selector.exists(".devilry-core-grade-full.devilry-core-grade-failed"))
    ...
    def test_passed(self):
        ...
        self.assertTrue(selector.exists(".devilry-core-grade-full.devilry-core-grade-passed"))
    ...
    def test_passed_failed_failed(self):
        ...
        self.assertTrue(
            selector.exists(".devilry-core-grade-full.devilry-core-grade.devilry-core-grade-mapper-passed-failed")
        )
        self.assertEqual("failed", selector.one(".devilry-core-grade .devilry-core-grade-main").alltext_normalized)
    ...
    def test_passed_failed_passed(self):
        ...
        self.assertEqual("passed", selector.one(".devilry-core-grade .devilry-core-grade-main").alltext_normalized)
    ...
    def test_raw_points(self):
        ...
        self.assertTrue(
            selector.exists(".devilry-core-grade-full.devilry-core-grade.devilry-core-grade-mapper-raw-points")
        )
        self.assertEqual("10/100", selector.one(".devilry-core-grade .devilry-core-grade-main").alltext_normalized)
    ...
    def test_custom_table(self):
        ...
        self.assertTrue(
            selector.exists(".devilry-core-grade-full.devilry-core-grade.devilry-core-grade-mapper-custom-table")
        )
        self.assertEqual("Bad", selector.one(".devilry-core-grade .devilry-core-grade-main").alltext_normalized)
    ...
    def test_details_students_can_see_points_false_not_student(self):
        ...
        self.assertEqual("8/10", selector.one(".devilry-core-grade-details-points").alltext_normalized)
    ...
    def test_details_is_passing_grade_true(self):
        ...
        self.assertEqual("passed", selector.one(".devilry-core-grade-details-is-passing-grade").alltext_normalized)
    ...
    def test_details_is_passing_grade_false(self):
        ...
        self.assertEqual("failed", selector.one(".devilry-core-grade-details-is-passing-grade").alltext_normalized)
    ...
    def test_passedfailed_grade_sanitycheck_students_can_see_points_true(self):
        ...
        self.assertEqual("passed (5/10)", selector.one(".devilry-core-grade").alltext_normalized)
    ...
    def test_rawpoints_grade_sanitycheck_students_can_see_points_true(self):
        ...
        self.assertEqual("5/10 (passed)", selector.one(".devilry-core-grade").alltext_normalized)
    ...
    def test_custom_table_full_grade_sanitycheck_students_can_see_points_true(self):
        ...
        self.assertEqual("Bad (passed - 5/10)", selector.one(".devilry-core-grade").alltext_normalized)
    ...
    def test_custom_table_full_grade_sanitycheck_students_can_see_points_false_student(self):
        ...
        self.assertEqual("Bad (passed)", selector.one(".devilry-core-grade").alltext_normalized)
...
class TestDevilryCommentSummary(test.TestCase):
    ...
    def test_zero_comments_from_students(self):
        ...
        self.assertEqual(
            "0 comments from student.", selector.one(".devilry-core-comment-summary-studentcomments").alltext_normalized
        )
    ...
    def test_one_comment_from_students(self):
        ...
        self.assertEqual(
            "1 comment from student.", selector.one(".devilry-core-comment-summary-studentcomments").alltext_normalized
        )
    ...
    def test_multiple_comments_from_students(self):
        ...
        self.assertEqual(
            "2 comments from student.", selector.one(".devilry-core-comment-summary-studentcomments").alltext_normalized
        )
    ...
    def test_zero_commentfiles_from_students(self):
        ...
        self.assertEqual(
            "0 files from student.", selector.one(".devilry-core-comment-summary-studentfiles").alltext_normalized
        )
    ...
    def test_one_commentfile_from_students(self):
        ...
        self.assertEqual(
            "1 file from student.", selector.one(".devilry-core-comment-summary-studentfiles").alltext_normalized
        )

    def test_multiple_commentfiles_from_students(self):
        testgroup = baker.make("core.AssignmentGroup")
        testcomment1 = baker.make(
            "devilry_group.GroupComment",
            feedback_set__group=testgroup,
            feedback_set__deadline_datetime=timezone.now(),
            visibility=GroupComment.VISIBILITY_VISIBLE_TO_EVERYONE,
        ...
        self.assertEqual(
            "2 files from student.", selector.one(".devilry-core-comment-summary-studentfiles").alltext_normalized
        )
    ...
    def test_zero_private_groupcomments_from_user(self):
        ...
        testgroup = AssignmentGroup.objects.annotate_with_number_of_private_groupcomments_from_user(
            user=testuser
        ).first()
        selector = htmls.S(
            render_to_string(
