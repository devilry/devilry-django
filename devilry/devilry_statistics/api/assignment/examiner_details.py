...
class ExaminerDetailsApi(AssignmentApiViewPreMixin, APIView):
    ...
    def get_queryset(self, assignment, relatedexaminer):
        queryset = coremodels.AssignmentGroup.objects.filter(parentnode_id=assignment.id).filter_user_is_examiner(
    ...
    def get_result(self, queryset):
        ...
        return queryset.aggregate(
            ...
            groups_with_passing_grade_count=models.Count(
                models.Case(
                    models.When(
            ...
            groups_corrected_count=models.Count(
                models.Case(
                    models.When(
                        cached_data__last_feedbackset=models.F("cached_data__last_published_feedbackset"), then=1
                    )
                )
            ),
            groups_with_failing_grade_count=models.Count(
                models.Case(
                    models.When(
                        cached_data__last_published_feedbackset__isnull=False,
                        cached_data__last_feedbackset=models.F("cached_data__last_published_feedbackset"),
            ...
            groups_waiting_for_deliveries_count=models.Count(
                models.Case(
                    models.When(
            ...
            groups_waiting_for_feedback_count=models.Count(
                models.Case(
                    models.When(
                        cached_data__last_feedbackset__grading_published_datetime__isnull=True,
            ...
            groups_waiting_for_deadline_to_expire_count=models.Count(
                models.Case(
                    models.When(
                        cached_data__last_feedbackset__grading_published_datetime__isnull=True,
                        cached_data__last_feedbackset__deadline_datetime__gt=now,
