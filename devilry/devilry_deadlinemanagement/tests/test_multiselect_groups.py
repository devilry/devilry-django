...
class TestCaseExaminerMixin(test.TestCase, cradmin_testhelpers.TestCaseMixin):
    ...
    def test_title(self):
        ...
        self.assertIn("Select groups", mockresponse.selector.one("title").alltext_normalized)
...
class TestExaminerNewAttemptMultiSelectView(TestCaseExaminerMixin):
    ...
    def test_search_anonymous_nomatch_fullname(self):
        ...
        baker.make("core.Examiner", relatedexaminer__user=examiner_user, assignmentgroup=testgroup1)
        baker.make("core.Examiner", relatedexaminer__user=examiner_user, assignmentgroup=testgroup2)
        baker.make("core.Candidate", assignment_group=testgroup1, relatedstudent__user__fullname="TestUser")
        mockresponse = self.mock_http200_getrequest_htmls(
            cradmin_role=testassignment,
            cradmin_instance=self._get_mock_instance(testassignment),
            requestuser=examiner_user,
    ...
    def test_search_anonymous_nomatch_candidate_id_from_candidate(self):
        ...
        baker.make("core.Examiner", relatedexaminer__user=examiner_user, assignmentgroup=testgroup1)
        baker.make("core.Examiner", relatedexaminer__user=examiner_user, assignmentgroup=testgroup2)
        baker.make("core.Candidate", assignment_group=testgroup1, candidate_id="MyCandidateID")
        mockresponse = self.mock_http200_getrequest_htmls(
            cradmin_role=testassignment,
            cradmin_instance=self._get_mock_instance(testassignment),
            requestuser=examiner_user,
    ...
    def test_search_anonymous_uses_custom_candidate_ids_nomatch_shortname(self):
        ...
        baker.make("core.Examiner", relatedexaminer__user=examiner_user, assignmentgroup=testgroup1)
        baker.make("core.Examiner", relatedexaminer__user=examiner_user, assignmentgroup=testgroup2)
        baker.make("core.Candidate", assignment_group=testgroup1, relatedstudent__user__shortname="testuser")
        mockresponse = self.mock_http200_getrequest_htmls(
            cradmin_role=testassignment,
            cradmin_instance=self._get_mock_instance(testassignment),
            requestuser=examiner_user,
    ...
    def test_post_num_queries(self):
        ...
        with self.assertNumQueries(3):
            self.mock_http302_postrequest(
                ...
                requestkwargs={"data": {"selected_items": [testgroup1.id, testgroup2.id, testgroup3.id]}},
            )
