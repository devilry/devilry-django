...
class TestManageDeadlineAllGroupsView(test.TestCase, cradmin_testhelpers.TestCaseMixin):
...
class TestManageDeadlineFromPreviousView(test.TestCase, cradmin_testhelpers.TestCaseMixin):
    """
