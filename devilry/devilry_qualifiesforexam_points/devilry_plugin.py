...
qualifiesforexam_plugins.add(
    ...
    description=_('Choose this option if you require your students to get a minimum number '
                  'of points in total on all or some of their assignments to qualify for final exams. '
