...
class TestExaminerDetailsView(test.TestCase, cradmin_testhelpers.TestCaseMixin):
    ...
    def test_title(self):
        ...
        self.assertIn("Test User - examiner", mockresponse.selector.one("title").alltext_normalized)
    ...
    def test_h1(self):
        ...
        self.assertEqual("Test User (examiner)", mockresponse.selector.one("h1").alltext_normalized)
    ...
    def test_buttonbar_add_students_link(self):
        ...
        self.assertEqual(
            ...
            mockresponse.selector.one("#devilry_admin_assignment_examinerdetails_button_add_students")["href"],
        )
    ...
    def test_buttonbar_add_students_text(self):
        ...
        self.assertEqual(
            ...
            mockresponse.selector.one(
                "#devilry_admin_assignment_examinerdetails_button_add_students"
            ).alltext_normalized,
        )
    ...
    def test_buttonbar_remove_students_link(self):
        ...
        self.assertEqual(
            ...
            mockresponse.selector.one("#devilry_admin_assignment_examinerdetails_button_remove_students")["href"],
        )
    ...
    def test_buttonbar_remove_students_text(self):
        ...
        self.assertEqual(
            ...
            mockresponse.selector.one(
                "#devilry_admin_assignment_examinerdetails_button_remove_students"
            ).alltext_normalized,
        )
