...
class TestAddGroupsToExaminerView(test.TestCase, cradmin_testhelpers.TestCaseMixin):
    ...
    def test_404_if_relatedexaminer_is_inactive(self):
        ...
        relatedexaminer = baker.make("core.RelatedExaminer", period=testassignment.period, active=False)
    ...
    def test_title(self):
        testassignment = baker.make("core.Assignment", long_name="Test Assignment")
        relatedexaminer = baker.make("core.RelatedExaminer", period=testassignment.period, user__fullname="Test User")
        baker.make("core.AssignmentGroup", parentnode=testassignment)
        ...
        self.assertIn("Add students to Test User", mockresponse.selector.one("title").alltext_normalized)
    ...
    def test_h1(self):
        ...
        self.assertEqual("Add students to Test User", mockresponse.selector.one("h1").alltext_normalized)
    ...
    def test_all_students_already_registered_on_examiner(self):
        ...
        messagesmock.add.assert_called_once_with(
            messages.INFO, "All students registered on this assignment has already been added to this examiner.", ""
        )
    ...
    def test_post_successmessage_no_projectgroups(self):
        ...
        messagesmock.add.assert_called_once_with(messages.SUCCESS, "Added 2 students.", "")
    ...
    def test_post_successmessage_with_single_projectgroups(self):
        ...
        self.mock_http302_postrequest(
            ...
            cradmin_instance=self.__mockinstance_with_devilryrole("departmentadmin"),
            viewkwargs={"relatedexaminer_id": relatedexaminer.id},
            requestkwargs={"data": {"selected_items": [str(testgroup1.id)]}},
        )
        messagesmock.add.assert_called_once_with(messages.SUCCESS, "Added 1 project group with 2 students.", "")
    ...
    def test_post_successmessage_with_multiple_projectgroups(self):
        ...
        messagesmock.add.assert_called_once_with(messages.SUCCESS, "Added 2 project groups with 18 students.", "")
