...
class TestRemoveGroupsToExaminerView(test.TestCase, cradmin_testhelpers.TestCaseMixin):
    ...
    def test_title(self):
        ...
        self.assertIn("Remove students from Test User", mockresponse.selector.one("title").alltext_normalized)
    ...
    def test_h1(self):
        ...
        self.assertEqual("Remove students from Test User", mockresponse.selector.one("h1").alltext_normalized)
    ...
    def test_no_groups_on_examiner(self):
        ...
        messagesmock.add.assert_called_once_with(messages.INFO, "No students to remove.", "")
    ...
    def test_post_successmessage_no_projectgroups(self):
        ...
        messagesmock.add.assert_called_once_with(messages.SUCCESS, "Removed 2 students.", "")
    ...
    def test_post_successmessage_with_single_projectgroups(self):
        ...
        messagesmock.add.assert_called_once_with(messages.SUCCESS, "Removed 1 project group with 2 students.", "")
    ...
    def test_post_successmessage_with_multiple_projectgroups(self):
        ...
        messagesmock.add.assert_called_once_with(messages.SUCCESS, "Removed 2 project groups with 18 students.", "")
