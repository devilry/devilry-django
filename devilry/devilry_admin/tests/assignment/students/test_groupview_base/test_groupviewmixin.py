...
class MinimalGroupViewMixin(groupview_base.GroupViewMixin, listbuilderview.FilterListMixin, listbuilderview.View):
...
class TestGroupViewMixin(test.TestCase, cradmin_testhelpers.TestCaseMixin):
    ...
    def test_examiner_count_2(self):
        ...
        self.assertEqual(["a"], self.__get_titles(mockresponse.selector))
    ...
    def test_examiner_count_filter_not_found(self):
        ...
        self.assertEqual([], self.__get_titles(mockresponse.selector))
    ...
    def test_candidate_count_filter_4(self):
        ...
        baker.make("core.Candidate", assignment_group=testgroup3, _quantity=7)
        mockresponse = self.mock_http200_getrequest_htmls(
            cradmin_role=testassignment,
            cradmin_instance=self.__mockinstance_with_devilryrole("departmentadmin"),
