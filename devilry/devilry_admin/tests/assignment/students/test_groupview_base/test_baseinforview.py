...
class MinimalInfoView(groupview_base.BaseInfoView):
    filterview_name = "filter"


class TestBaseInfoView(test.TestCase, cradmin_testhelpers.TestCaseMixin):
    """
    ...
    def test_filter_all_empty(self):
        ...
        self.assertEqual(
            "No students.", mockresponse.selector.one(".cradmin-legacy-listing-no-items-message").alltext_normalized
        )
