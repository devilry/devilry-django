...
class TestOverview(test.TestCase, cradmin_testhelpers.TestCaseMixin):
    ...
    def test_title(self):
        ...
        self.assertIn("Students on Test Assignment", mockresponse.selector.one("title").alltext_normalized)
    ...
    def test_h1(self):
        ...
        self.assertEqual("Students on Test Assignment", mockresponse.selector.one("h1").alltext_normalized)
    ...
    def test_buttonbar_sanity(self):
        ...
        self.assertEqual(4, mockresponse.selector.count("#devilry_admin_assignment_students_overview_buttonbar .btn"))
    ...
    def test_buttonbar_create_groups_link(self):
        ...
        self.assertEqual(
            "/create_groups/INDEX",
            mockresponse.selector.one("#devilry_admin_assignment_students_overview_button_create_groups")["href"],
        )

    def test_buttonbar_create_groups_text(self):
        testassignment = baker.make(
            "core.Assignment", parentnode__short_name="testperiod", parentnode__parentnode__short_name="testsubject"
        )
        mockresponse = self.mock_http200_getrequest_htmls(
            cradmin_role=testassignment, cradmin_instance=self.__mockinstance_with_devilryrole("departmentadmin")
        )
        self.assertEqual(
            ...
            mockresponse.selector.one(
                "#devilry_admin_assignment_students_overview_button_create_groups"
            ).alltext_normalized,
        )
    ...
    def test_buttonbar_merge_groups_link(self):
        ...
        self.assertEqual(
            "/merge_groups/INDEX",
            mockresponse.selector.one("#devilry_admin_assignment_students_overview_button_merge_groups")["href"],
        )
    ...
    def test_buttonbar_merge_groups_text(self):
        ...
        self.assertEqual(
            ...
            mockresponse.selector.one(
                "#devilry_admin_assignment_students_overview_button_merge_groups"
            ).alltext_normalized,
        )
    ...
    def test_buttonbar_delete_groups_link(self):
        ...
        self.assertEqual(
            "/delete_groups/INDEX",
            mockresponse.selector.one("#devilry_admin_assignment_students_overview_button_delete_groups")["href"],
        )
    ...
    def test_buttonbar_delete_groups_text(self):
        ...
        self.assertEqual(
            "Remove students",
            mockresponse.selector.one(
                "#devilry_admin_assignment_students_overview_button_delete_groups"
            ).alltext_normalized,
        )
    ...
    def test_anonymizationmode_fully_anonymous_subjectadmin_no_link(self):
        ...
        self.assertFalse(mockresponse.selector.exists(".devilry-admin-assignment-students-overview-group-linkframe"))
    ...
    def test_anonymizationmode_fully_anonymous_departmentadmin_has_link(self):
        ...
        self.assertTrue(mockresponse.selector.exists(".devilry-admin-assignment-students-overview-group-linkframe"))
