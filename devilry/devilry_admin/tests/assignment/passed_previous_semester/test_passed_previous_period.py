...
class TestSelectPeriodViewAnonymization(TestCase, cradmin_testhelpers.TestCaseMixin):
    ...
    def test_404_anonymizationmode_fully_subjectadmin(self):
        ...
        with self.assertRaises(Http404):
            self.mock_http200_getrequest_htmls(
                cradmin_role=testassignment, cradmin_instance=self.__mockinstance_with_devilryrole("subjectadmin")
            )
    ...
    def test_404_anonymizationmode_fully_periodadmin(self):
        ...
        with self.assertRaises(Http404):
            self.mock_http200_getrequest_htmls(
                cradmin_role=testassignment, cradmin_instance=self.__mockinstance_with_devilryrole("periodadmin")
            )
...
class TestSelectPeriodView(TestCase, cradmin_testhelpers.TestCaseMixin):
    ...
    def test_submit_button_text_sanity(self):
        ...
        self.assertIn("Next", mockresponse.selector.one("#submit-id-next").alltext_normalized)
    ...
    def test_select_previous_period_simple(self):
        ...
        selectlist = [
            elem.alltext_normalized.split(" (")[0] for elem in mockresponse.selector.list(".controls  > .radio")
        ]
        self.assertEqual(1, len(selectlist))
        self.assertNotIn(
            "{} - {}".format(testassignment.parentnode.short_name, testassignment.parentnode.long_name), selectlist
        )
        self.assertIn("{} - {}".format(period.short_name, period.long_name), selectlist)
    ...
    def test_select_previous_period_multiple(self):
        ...
        self.assertIn("{} - {}".format(period1.short_name, period1.long_name), selectlist)
        self.assertIn("{} - {}".format(period2.short_name, period2.long_name), selectlist)
        self.assertIn("{} - {}".format(period3.short_name, period3.long_name), selectlist)
    ...
    def test_select_previous_period_multiple_not_in(self):
        ...
        self.assertNotIn("{} - {}".format(period1.short_name, period1.long_name), selectlist)
        self.assertNotIn("{} - {}".format(period2.short_name, period2.long_name), selectlist)
        self.assertIn("{} - {}".format(period3.short_name, period3.long_name), selectlist)
    ...
    def test_select_previous_period_multiple_future_not_in(self):
        ...
        self.assertIn("{} - {}".format(period1.short_name, period1.long_name), selectlist)
        self.assertNotIn("{} - {}".format(period2.short_name, period2.long_name), selectlist)
        self.assertNotIn("{} - {}".format(period3.short_name, period3.long_name), selectlist)
...
class TestPassedPreviousAssignmentView(TestCase, cradmin_testhelpers.TestCaseMixin):
    ...
    def test_title(self):
        ...
        self.assertIn("Confirm assignments", mockresponse.selector.one("title").alltext_normalized)
    ...
    def test_h1(self):
        ...
        self.assertIn("Step 2 of 3: Confirm assignments", mockresponse.selector.one("h1").alltext_normalized)
    ...
    def test_next_button(self):
        ...
        self.assertIn("Next", mockresponse.selector.one(".btn-primary").alltext_normalized)
    ...
    def test_links(self):
        ...
        self.assertEqual(
            mock.call(
                ...
                args=(),
                kwargs={"period_id": testassignment.parentnode.id},
                viewname="confirm",
            ),
...
class TestPassedPreviousAssignmentViewListbuilder(TestCase, cradmin_testhelpers.TestCaseMixin):
    ...
    def test_simple_description(self):
        ...
        valuelist = [
            ...
            for elem in mockresponse.selector.list(".cradmin-legacy-listbuilder-itemvalue-titledescription-description")
        ]
        self.assertEqual(2, len(valuelist))
        self.assertIn(
            "{}/{} (max points/passing grade)".format(
                testassignment1.max_points, testassignment1.passing_grade_min_points
            ),
            valuelist,
        )
    ...
    def test_simple(self):
        ...
        valuelist = [
            elem.alltext_normalized
            for elem in mockresponse.selector.list(".cradmin-legacy-listbuilder-itemvalue-titledescription-title")
        ]
        self.assertEqual(1, len(valuelist))
        self.assertNotIn("{} - {}".format(testassignment2.long_name, testassignment2.parentnode.long_name), valuelist)
    ...
    def test_multiple_assignments(self):
        ...
        self.assertNotIn("{} - {}".format(testassignment.long_name, testassignment.parentnode.long_name), valuelist)
        self.assertIn("{} - {}".format(testassignment1.long_name, testassignment1.parentnode.long_name), valuelist)
        self.assertIn("{} - {}".format(testassignment2.long_name, testassignment2.parentnode.long_name), valuelist)
        self.assertIn("{} - {}".format(testassignment3.long_name, testassignment3.parentnode.long_name), valuelist)
    ...
    def test_multiple_assignments_not_in(self):
        ...
        self.assertEqual(1, len(valuelist))
        self.assertNotIn("{} - {}".format(testassignment.long_name, testassignment.parentnode.long_name), valuelist)
        self.assertNotIn("{} - {}".format(testassignment1.long_name, testassignment1.parentnode.long_name), valuelist)
        self.assertNotIn("{} - {}".format(testassignment2.long_name, testassignment2.parentnode.long_name), valuelist)
        self.assertIn("{} - {}".format(testassignment3.long_name, testassignment3.parentnode.long_name), valuelist)
    ...
    def test_select_previous_period_multiple_future_not_in(self):
        ...
        self.assertIn("{} - {}".format(testassignment1.long_name, testassignment1.parentnode.long_name), valuelist)
        self.assertNotIn("{} - {}".format(testassignment2.long_name, testassignment2.parentnode.long_name), valuelist)
        self.assertNotIn("{} - {}".format(testassignment3.long_name, testassignment3.parentnode.long_name), valuelist)
...
class TestApprovePreviousView(TestCase, cradmin_testhelpers.TestCaseMixin):
    ...
    def test_title(self):
        ...
        self.assertIn("Approve assignments", mockresponse.selector.one("title").alltext_normalized)
    ...
    def test_confirm_button(self):
        ...
        self.assertIn("Confirm", mockresponse.selector.one("#submit-id-confirm").alltext_normalized)
...
class TestApprovePreviousPostView(TestCase, cradmin_testhelpers.TestCaseMixin):
    ...
    def test_success_simple(self):
        ...
        self.mock_http302_postrequest(
            ...
            viewkwargs={"period_id": testassignment1.parentnode.id},
            messagesmock=messagesmock,
            requestkwargs={"data": {"candidates": "[{}]".format(candidate1.id)}},
            cradmin_instance=self.__mockinstance_with_devilryrole("departmentadmin"),
        )
        feedbackset_passed_previous_period = FeedbacksetPassedPreviousPeriod.objects.get()
        self.assertEqual(
            feedbackset_passed_previous_period.passed_previous_period_type,
    ...
    def test_success_multiple(self):
        ...
        self.mock_http302_postrequest(
            ...
            viewkwargs={"period_id": testassignment1.parentnode.id},
            messagesmock=messagesmock,
            requestkwargs={"data": {"candidates": "[{}, {}, {}]".format(candidate1.id, candidate2.id, candidate3.id)}},
            cradmin_instance=self.__mockinstance_with_devilryrole("departmentadmin"),
        )
        messagesmock.add.assert_called_once_with(
            messages.SUCCESS,
            "{}, {}, {} was marked as approved for this assignment.".format(
    ...
    def test_warning_some_candidates_does_not_qualify(self):
        ...
        messagesmock.add.assert_called_once_with(
            messages.WARNING, "Some students does not qualify to pass the assignment.", ""
        )
