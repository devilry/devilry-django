...
class TestPeriodTagListbuilderView(test.TestCase, cradmin_testhelpers.TestCaseMixin):
    ...
    def test_title(self):
        ...
        self.assertEqual(
            mockresponse.selector.one("title").alltext_normalized, "Tags on {}".format(testperiod.parentnode)
        )
    ...
    def test_related_students_rendered(self):
        ...
        relatedstudent1 = baker.make("core.RelatedStudent", period=testperiod, user__shortname="relatedstudent1")
        relatedstudent2 = baker.make("core.RelatedStudent", period=testperiod, user__shortname="relatedstudent2")
        ...
        self.assertEqual(
            mockresponse.selector.one(".devilry-core-periodtag-relatedstudents").alltext_normalized,
    ...
    def test_no_related_students_rendered(self):
        ...
        self.assertEqual(
            mockresponse.selector.one(".devilry-core-periodtag-no-relatedstudents").alltext_normalized, "NO STUDENTS"
        )

    def test_related_examiners_rendered(self):
        testperiod = baker.make("core.Period")
        testperiodtag = baker.make("core.PeriodTag", period=testperiod)
        relatedexaminer1 = baker.make("core.RelatedExaminer", period=testperiod, user__shortname="relatedexaminer1")
        relatedexaminer2 = baker.make("core.RelatedExaminer", period=testperiod, user__shortname="relatedexaminer2")
        ...
        self.assertIn(
            "Examiners: ", mockresponse.selector.one(".devilry-core-periodtag-relatedexaminers").alltext_normalized
        )
    ...
    def test_no_related_examiners_rendered(self):
        ...
        self.assertEqual(
            mockresponse.selector.one(".devilry-core-periodtag-no-relatedexaminers").alltext_normalized, "NO EXAMINERS"
        )
    ...
    def test_filter_search_on_tag(self):
        ...
        mockresponse = self.mock_http200_getrequest_htmls(
            cradmin_role=testperiod, viewkwargs={"filters_string": "search-tag1"}
        )
    ...
    def test_filter_search_on_tag_no_results(self):
        ...
        baker.make("core.PeriodTag", period=testperiod, prefix="tag2")
        mockresponse = self.mock_http200_getrequest_htmls(
            cradmin_role=testperiod, viewkwargs={"filters_string": "search-tag3"}
        )
    ...
    def test_filter_search_on_student_user_shortname(self):
        ...
        mockresponse = self.mock_http200_getrequest_htmls(
            cradmin_role=testperiod, viewkwargs={"filters_string": "search-relatedstudent1"}
        )
        self.assertEqual(mockresponse.selector.count(".cradmin-legacy-listbuilder-itemvalue"), 1)
        self.assertContains(mockresponse.response, "tag1")
    ...
    def test_filter_search_on_student_user_shortname_matches_both(self):
        ...
        mockresponse = self.mock_http200_getrequest_htmls(
            cradmin_role=testperiod, viewkwargs={"filters_string": "search-relatedstudent"}
        )
    ...
    def test_filter_search_on_student_user_shortname_no_result(self):
        ...
        mockresponse = self.mock_http200_getrequest_htmls(
            cradmin_role=testperiod, viewkwargs={"filters_string": "search-relatedstudent_c"}
        )
        self.assertEqual(mockresponse.selector.count(".cradmin-legacy-listbuilder-itemvalue"), 0)
        self.assertNotContains(mockresponse.response, "tag1")
    ...
    def test_filter_search_on_examiner_user_shortname(self):
        ...
        mockresponse = self.mock_http200_getrequest_htmls(
            cradmin_role=testperiod, viewkwargs={"filters_string": "search-relatedexaminer1"}
        )
        self.assertEqual(mockresponse.selector.count(".cradmin-legacy-listbuilder-itemvalue"), 1)
        self.assertContains(mockresponse.response, "tag1")
    ...
    def test_filter_search_on_examiner_user_shortname_matches_both(self):
        ...
        mockresponse = self.mock_http200_getrequest_htmls(
            cradmin_role=testperiod, viewkwargs={"filters_string": "search-relatedexaminer"}
        )
        self.assertEqual(mockresponse.selector.count(".cradmin-legacy-listbuilder-itemvalue"), 2)
        self.assertContains(mockresponse.response, "tag1")
    ...
    def test_filter_search_on_examiner_user_shortname_no_result(self):
        ...
        mockresponse = self.mock_http200_getrequest_htmls(
            cradmin_role=testperiod, viewkwargs={"filters_string": "search-relatedexaminer_c"}
        )
        self.assertEqual(mockresponse.selector.count(".cradmin-legacy-listbuilder-itemvalue"), 0)
        self.assertNotContains(mockresponse.response, "tag1")
    ...
    def test_filter_radio_show_hidden_tags_only(self):
        ...
        mockresponse = self.mock_http200_getrequest_htmls(
            cradmin_role=testperiod, viewkwargs={"filters_string": "is_hidden-show-hidden-tags-only"}
        )
        self.assertEqual(mockresponse.selector.count(".cradmin-legacy-listbuilder-itemvalue"), 1)
        self.assertNotContains(mockresponse.response, "tag1")
        self.assertNotContains(mockresponse.response, "tag2")
    ...
    def test_filter_radio_show_visible_tags_only(self):
        ...
        mockresponse = self.mock_http200_getrequest_htmls(
            cradmin_role=testperiod, viewkwargs={"filters_string": "is_hidden-show-visible-tags-only"}
        )
        self.assertEqual(mockresponse.selector.count(".cradmin-legacy-listbuilder-itemvalue"), 3)
        self.assertContains(mockresponse.response, "tag1")
        self.assertContains(mockresponse.response, "tag2")
    ...
    def test_filter_radio_show_custom_tags_only(self):
        ...
        baker.make("core.PeriodTag", period=testperiod, prefix="a", tag="tag3", is_hidden=True)
        mockresponse = self.mock_http200_getrequest_htmls(
            cradmin_role=testperiod, viewkwargs={"filters_string": "is_hidden-show-custom-tags-only"}
        )
        self.assertEqual(mockresponse.selector.count(".cradmin-legacy-listbuilder-itemvalue"), 2)
        self.assertContains(mockresponse.response, "tag1")
        self.assertContains(mockresponse.response, "tag2")
    ...
    def test_filter_radio_show_imported_tags_only(self):
        ...
        baker.make("core.PeriodTag", period=testperiod, prefix="a", tag="tag3", is_hidden=True)
        mockresponse = self.mock_http200_getrequest_htmls(
            cradmin_role=testperiod, viewkwargs={"filters_string": "is_hidden-show-imported-tags-only"}
        )
        self.assertEqual(mockresponse.selector.count(".cradmin-legacy-listbuilder-itemvalue"), 1)
        self.assertNotContains(mockresponse.response, "tag1")
        self.assertNotContains(mockresponse.response, "tag2")
...
class TestHideShowPeriodTag(test.TestCase, cradmin_testhelpers.TestCaseMixin):
    ...
    def test_period_missing_tag_id_parameter_raises_404(self):
        ...
        with self.assertRaisesMessage(Http404, "Missing parameters."):
            self.mock_getrequest(cradmin_role=testperiod, requestkwargs={"data": {}})

    def test_period_tag_does_not_exist(self):
        testperiod = baker.make("core.Period")
        with self.assertRaisesMessage(Http404, "Tag does not exist."):
            self.mock_getrequest(cradmin_role=testperiod, requestkwargs={"data": {"tag_id": 1}})

    def test_period_tag_is_hidden_toggled_true(self):
        testperiod = baker.make("core.Period")
        testperiodtag = baker.make("core.PeriodTag", period=testperiod)
        self.mock_getrequest(cradmin_role=testperiod, requestkwargs={"data": {"tag_id": testperiodtag.id}})
...
class TestAddTags(test.TestCase, cradmin_testhelpers.TestCaseMixin):
    ...
    def test_empty_tag_raises_validation_error(self):
        ...
        mockresponse = self.mock_http200_postrequest_htmls(
            cradmin_role=testperiod, requestkwargs={"data": {"tag_text": ""}}
        )
        self.assertEqual(
            mockresponse.selector.one("#error_1_id_tag_text").alltext_normalized, "This field is required."
        )
    ...
    def test_empty_tags_ignored(self):
        testperiod = baker.make("core.Period")
        self.mock_http302_postrequest(cradmin_role=testperiod, requestkwargs={"data": {"tag_text": " tag1, , ,tag4 "}})
    ...
    def test_add_single_tag_message(self):
        ...
        self.assertEqual(1, PeriodTag.objects.count())
        messagesmock.add.assert_called_once_with(messages.SUCCESS, "1 tag(s) added", "")
    ...
    def test_add_multiple_tags_message(self):
        ...
        self.assertEqual(2, PeriodTag.objects.count())
        messagesmock.add.assert_called_once_with(messages.SUCCESS, "2 tag(s) added", "")
    ...
    def test_add_single_tag_already_exists(self):
        ...
        self.assertEqual(1, PeriodTag.objects.count())
        messagesmock.add.assert_called_once_with(messages.ERROR, "The tag(s) you wanted to add already exists.", "")
...
class TestEditTag(test.TestCase, cradmin_testhelpers.TestCaseMixin):
    ...
    def test_title(self):
        testperiod = baker.make("core.Period")
        testperiodtag = baker.make("core.PeriodTag", period=testperiod)
        mockresponse = self.mock_http200_getrequest_htmls(cradmin_role=testperiod, viewkwargs={"pk": testperiodtag.id})
        self.assertEqual(
    ...
    def test_tag_with_prefix_raises_404(self):
        ...
        with self.assertRaises(Http404):
            self.mock_http200_getrequest_htmls(cradmin_role=testperiod, viewkwargs={"pk": testperiodtag.id})

    def test_rename_tag(self):
        testperiod = baker.make("core.Period")
        testperiodtag = baker.make("core.PeriodTag", period=testperiod, tag="tag1")
        self.mock_http302_postrequest(
            cradmin_role=testperiod, viewkwargs={"pk": testperiodtag.id}, requestkwargs={"data": {"tag": "tag2"}}
        )
    ...
    def test_rename_tag_to_existing_tag(self):
        ...
        mockresponse = self.mock_http200_postrequest_htmls(
            cradmin_role=testperiod,
            viewkwargs={"pk": testperiodtag.id},
            requestkwargs={"data": {"tag": "tag2"}},
            messagesmock=messagesmock,
        )
    ...
    def test_error_tag_contains_comma(self):
        ...
        mockresponse = self.mock_http200_postrequest_htmls(
            cradmin_role=testperiod,
            viewkwargs={"pk": testperiodtag.id},
            requestkwargs={"data": {"tag": "tag1,asd"}},
            messagesmock=messagesmock,
        )
...
class TestDeleteTag(test.TestCase, cradmin_testhelpers.TestCaseMixin):
    ...
    def test_delete_tag(self):
        ...
        testperiodtag = baker.make("core.PeriodTag", period=testperiod)
        baker.make("core.PeriodTag", period=testperiod)
        self.mock_http302_postrequest(cradmin_role=testperiod, viewkwargs={"pk": testperiodtag.id})
        with self.assertRaises(PeriodTag.DoesNotExist):
...
class TestMultiSelectAddRelatedUserView(test.TestCase, cradmin_testhelpers.TestCaseMixin):
    ...
    def test_get_title(self):
        ...
        testperiodtag = baker.make("core.PeriodTag", period=testperiod, tag="a")
        mockresponse = self.mock_http200_getrequest_htmls(
            cradmin_role=testperiod, viewkwargs={"tag_id": testperiodtag.id}
        )
        self.assertEqual("Add examiner to a", mockresponse.selector.one("title").alltext_normalized)
    ...
    def test_only_users_on_period_are_listed(self):
        ...
        mockresponse = self.mock_http200_getrequest_htmls(
            cradmin_role=testperiod1, viewkwargs={"tag_id": period1_tag.id}
        )
...
class TestMultiSelectRemoveRelatedUserView(test.TestCase, cradmin_testhelpers.TestCaseMixin):
    ...
    def test_get_title(self):
        ...
        self.assertEqual("Remove examiner from a", mockresponse.selector.one("title").alltext_normalized)
    ...
    def test_only_users_on_period_are_listed(self):
        ...
        testrelatedexaminer1 = baker.make(
            "core.RelatedExaminer", period=testperiod1, user__shortname="shortname_user_testperiod1"
        )
        testrelatedexaminer2 = baker.make(
            "core.RelatedExaminer", period=testperiod2, user__shortname="shortname_user_testperiod2"
        )
        testperiodtag1.relatedexaminers.add(testrelatedexaminer1)
        testperiodtag2.relatedexaminers.add(testrelatedexaminer2)
        mockresponse = self.mock_http200_getrequest_htmls(
            cradmin_role=testperiod1, viewkwargs={"tag_id": testperiodtag1.id}
        )
        self.assertEqual(1, mockresponse.selector.count(".cradmin-legacy-multiselect2-itemvalue"))
        self.assertContains(mockresponse.response, "shortname_user_testperiod1")
        self.assertNotContains(mockresponse.response, "shortname_user_testperiod2")
