...
class UpdateView(crudbase.OnlySaveButtonMixin, createsubject.CreateUpdateMixin, update.UpdateRoleView):
    ...
    def get_pagetitle(self):
        ...
        return gettext_lazy("Edit %(subject)s") % {"subject": subject.get_path()}
...
class App(crapp.App):
    appurls = [
        crapp.Url(r"^", UpdateView.as_view(), name=crapp.INDEXVIEW_NAME),
    ]
