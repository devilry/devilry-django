...
class AssignmentDeadlineHandlingUpdateView(OnlySaveButtonMixin, UpdateView):
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        user_devilry_role = SubjectPermissionGroup.objects.get_devilryrole_for_user_on_subject(
    ...
    def __get_deadline_handling_choices(self):
        return [
            (
                ...
                pgettext_lazy(
                    "deadline handling update hard choice",
    ...
    def get_success_message(self, object):
        ...
        return pgettext_lazy(
            "assignment config",
            'Changed deadline handling from "%(old_deadline_handling_text)s" to "%(new_deadline_handling_text)s".',
        ) % {
