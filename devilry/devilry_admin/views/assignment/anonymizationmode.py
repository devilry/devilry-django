...
class AssignmentAnonymizationmodeUpdateView(OnlySaveButtonMixin, UpdateView):
    ...
    def get_success_message(self, object):
        ...
        return pgettext_lazy(
            "assignment config",
            'Changed anonymization mode from "%(old_anonymizationmode)s" to "%(new_anonymizationmode)s".',
        ) % {"old_anonymizationmode": old_anonymizationmode, "new_anonymizationmode": new_anonymizationmode}
