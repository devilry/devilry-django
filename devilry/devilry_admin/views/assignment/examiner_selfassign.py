...
class AssignmentExaminerSelfAssignUpdateView(OnlySaveButtonMixin, UpdateView):
    ...
    def get_pagetitle(self):
        return pgettext_lazy("admin examiner selfassign setting", "Edit examiner self-assign")
    ...
    def get_success_message(self, object):
        ...
        if assignment.examiners_can_self_assign and self._old_selfassign_enabled_value:
            if assignment.examiner_self_assign_limit != self._old_selfassign_limit_value:
                ...
                ) % {"old_limit": self._old_selfassign_limit_value, "new_limit": assignment.examiner_self_assign_limit}
            ...
            # Disabled
            success_message = pgettext_lazy("admin examiner selfassign setting", "Examiner self-assign disabled.")
