...
class UpdateView(crudbase.OnlySaveButtonMixin, createperiod.CreateUpdateMixin, update.UpdateRoleView):
    ...
    def get_pagetitle(self):
        ...
        return gettext_lazy("Edit %(period)s") % {"period": period.get_path()}
