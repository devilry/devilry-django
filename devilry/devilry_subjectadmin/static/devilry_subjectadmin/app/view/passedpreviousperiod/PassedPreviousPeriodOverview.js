            ...
            items: [{
                ...
                items: [{
                    ...
                    items: [{
                        ...
                        tpl: [
                            '<p>',
                                gettext('Select one or more groups. Groups that we belive have passed this assignment before has been selected automatically, and they are marked with the name of the old term.'),
                            '</p>',
                            '<p>{MORE_BUTTON}</p>',
                            '<div {MORE_ATTRS}>',
                                '<p>',
                            ...
                            '<tpl if="needsGradeFormatExplained">',
                                '<div class="gradeformat-help">',
                                    ...
                                    '<p>',
                                        ...
                                        '<small> ',
                                            gettext('You must specify passing grades. Many users find it confusing when the autodetected grade is not a passing grade, but that is simply because the grading system has been configured differently this term.'),
                                        '</small>',
                                    '</p>',
                                '</div>',
                            '</tpl>',
