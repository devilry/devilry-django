Ext.define('devilry_subjectadmin.view.detailedperiodoverview.PeriodOverviewIgnoredMenu', {
    ...
    bodyTpl: [
        '<tpl if="!loading">',
            '<p>',
                gettext('Some students are registered on groups within this term, but are not registered on the term. It is common to remove students from the term when they quit the course, so this may not indicate a problem.'),
            '</p>',
            '<ul class="unstyled">',
                '<li>',
                    '<span class="badge badge-important">{ignored_with_feedback_count}</span> ',
                    '<small>',
                        gettext('Students in groups with feedback and not registered on the term.'),
                    '</small>',
                '</li>',
                '<li>',
                    '<span class="badge badge-info">{ignored_without_feedback_count}</span> ',
                    '<small>',
                        gettext('Students in groups without feedback but not registered on the term.'),
                    '</small>',
                '</li>',
            '</ul>',
            ...
            ' &nbsp;<a class="new-window-link" href="{manageRelatedStudentsUrl}" target="_blank">',
                gettext('Edit/view students on the term'),
            '</a>',
        '</tpl>'
    ],
