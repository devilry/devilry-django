...
class TestFeedbacksetPassedPreviousPeriod(TestCase):
    ...
    def test_assignment_data_is_correct(self):
        ...
        self.assertEqual(
            self.feedbackset_passed_previous.assignment_passing_grade_min_points,
    ...
    def test_old_grading_data_is_correct(self):
        ...
        self.assertEqual(
            self.feedbackset_passed_previous.grading_published_by, self.previous_feedbackset.grading_published_by
        )
        self.assertEqual(
            self.feedbackset_passed_previous.grading_published_datetime,
