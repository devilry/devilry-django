...
# class TestTimeLineBuilderNew(TestCase):
#
#     def setUp(self):
#         AssignmentGroupDbCacheCustomSql().initialize()
#
...
#             feedbacksets=feedbackset_queryset,
#             group=testgroup)
#         timelinebuilder.build_new()
#         builder_list = timelinebuilder.get_as_list()
#         self.assertEquals(builder_list[0]['feedbackset'], testfeedbackset1)
#         self.assertEquals(builder_list[1]['feedbackset'], testfeedbackset2)
#
#         feedbackset1_events_list = builder_list[0]['feedbackset_events']
#         feedbackset2_events_list = builder_list[1]['feedbackset_events']
#
#         self.assertEquals(feedbackset1_events_list[0]['type'], 'comment')
#         self.assertEquals(feedbackset1_events_list[1]['type'], 'deadline_expired')
#         self.assertEquals(feedbackset1_events_list[2]['type'], 'comment')
#         self.assertEquals(feedbackset1_events_list[3]['type'], 'grade')
#
#         self.assertEquals(feedbackset2_events_list[0]['type'], 'comment')
#         self.assertEquals(feedbackset2_events_list[1]['type'], 'deadline_expired')
#         self.assertEquals(feedbackset2_events_list[2]['type'], 'comment')
#         self.assertEquals(feedbackset2_events_list[3]['type'], 'grade')
