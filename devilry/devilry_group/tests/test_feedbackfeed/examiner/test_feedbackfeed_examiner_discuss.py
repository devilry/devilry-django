...
class TestFeedbackfeedExaminerPublicDiscuss(TestCase, test_feedbackfeed_examiner.TestFeedbackfeedExaminerMixin):
...
class TestFeedbackfeedExaminerWithAdminDiscuss(TestCase, test_feedbackfeed_examiner.TestFeedbackfeedExaminerMixin):
