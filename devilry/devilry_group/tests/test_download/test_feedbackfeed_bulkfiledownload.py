...
class TestBulkFileDownloadBase(AbstractTestCase):
    ...
    def test_get_zipfile(self):
        ...
        baker.make("core.Candidate", assignment_group=assignmentgroup1, relatedstudent__user__shortname="testuser1")
        tomorrow = timezone.now() + datetime.timedelta(days=1)
        feedbackset1 = baker.make(
        ...
        comment_fbs1_1 = baker.make(
            "devilry_group.GroupComment", feedback_set=feedbackset1, user_role=Comment.USER_ROLE_STUDENT
        )
        commentfile_fbs1_1 = baker.make("devilry_comment.CommentFile", comment=comment_fbs1_1, filename="testfile1.txt")
    ...
    def test_multiple_students_in_assignmentgroup(self):
        ...
        baker.make("core.Candidate", assignment_group=assignmentgroup1, relatedstudent__user__shortname="testuser1")
        baker.make("core.Candidate", assignment_group=assignmentgroup1, relatedstudent__user__shortname="testuser2")
        tomorrow = timezone.now() + datetime.timedelta(days=1)
        feedbackset1 = baker.make(
            "devilry_group.FeedbackSet",
            group=assignmentgroup1,
    ...
    def test_multiple_attempts(self):
        ...
        comment_fbs2_1 = baker.make(
            "devilry_group.GroupComment", feedback_set=feedbackset2, user_role=Comment.USER_ROLE_STUDENT
        )
        commentfile_fbs2_1 = baker.make("devilry_comment.CommentFile", comment=comment_fbs2_1, filename="testfile2.txt")
    ...
    def test_multiple_files_same_attempt_same_name(self):
        ...
        comment_fbs1_2 = baker.make(
            "devilry_group.GroupComment", feedback_set=feedbackset1, user_role=Comment.USER_ROLE_STUDENT
        )
        commentfile_fbs1_2 = baker.make("devilry_comment.CommentFile", comment=comment_fbs1_2, filename="testfile1.txt")
    ...
    def test_multiple_files_same_comment_same_name(self):
        ...
        commentfile_fbs1_2 = baker.make("devilry_comment.CommentFile", comment=comment_fbs1_2, filename="testfile1.txt")
        commentfile_fbs1_2.file.save("testfile1.txt", ContentFile("test2"))
        commentfile_fbs1_2_2 = baker.make(
            "devilry_comment.CommentFile", comment=comment_fbs1_2, filename="testfile1.txt"
        )
    ...
    def test_file_from_examiner(self):
        ...
        comment_fbs1_1 = baker.make(
            "devilry_group.GroupComment", feedback_set=feedbackset1, user_role=Comment.USER_ROLE_EXAMINER
        )
        commentfile_fbs1_1 = baker.make("devilry_comment.CommentFile", comment=comment_fbs1_1, filename="testfile1.txt")
        commentfile_fbs1_1.file.save("testfile1.txt", ContentFile("test"))
    ...
    def test_multiple_assignmentgroups(self):
        ...
        comment_fbs1 = baker.make(
            "devilry_group.GroupComment", feedback_set=feedbackset1, user_role=Comment.USER_ROLE_STUDENT
        )
        commentfile_fbs1 = baker.make("devilry_comment.CommentFile", comment=comment_fbs1, filename="testfile1.txt")
        commentfile_fbs1.file.save("testfile1.txt", ContentFile("test"))

        assignmentgroup2 = baker.make("core.AssignmentGroup", parentnode=assignmentgroup1.parentnode)
        baker.make("core.Candidate", assignment_group=assignmentgroup2, relatedstudent__user__shortname="testuser2")
        feedbackset2 = baker.make(
            "devilry_group.FeedbackSet",
        ...
        comment_fbs2 = baker.make(
            "devilry_group.GroupComment", feedback_set=feedbackset2, user_role=Comment.USER_ROLE_STUDENT
        )
        commentfile_fbs2 = baker.make("devilry_comment.CommentFile", comment=comment_fbs2, filename="testfile2.txt")
