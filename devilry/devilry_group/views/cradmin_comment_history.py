...
from devilry.devilry_cradmin.devilry_listbuilder.feedbackfeed_timeline import (
    StudentGroupCommentItemValueMinimal,
    ExaminerGroupCommentItemValueMinimal,
    AdminGroupCommentItemValueMinimal,
)
...
class CommentHistoryView(listbuilderview.View):
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        if (
            self.group_comment.visibility == group_models.GroupComment.VISIBILITY_PRIVATE
    ...
    def get_current_group_comment_renderable(self):
        ...
        group_user_lookup = GroupUserLookup(
            group=group, assignment=assignment, requestuser=self.request.user, requestuser_devilryrole=devilry_viewrole
        )
