...
class GradeModel(models.Model):
    ...
    def update_gradeplugin_cached_fields(self):
        """ Run this to update all the cached fields generated by grade
        plugins in :class:`devilry.core.models.AssignmentGroup`. """
        assignment_group = self.get_feedback_obj().delivery.assignment_group
        assignment_group.update_gradeplugin_cached_fields()
