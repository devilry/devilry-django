...
class TestAssignmentGroup(TestCase):
    ...
    def test_where_is_admin(self):
        ...
        self.assertEquals(3, AssignmentGroup.where_is_admin(uioadmin).count())
    ...
    def test_where_is_student(self):
        ...
        self.assertEquals(2, AssignmentGroup.where_is_student(student3).count())
    ...
    def test_where_is_examiner(self):
        ...
        self.assertEquals(2,
                AssignmentGroup.where_is_examiner(examiner1).count())
