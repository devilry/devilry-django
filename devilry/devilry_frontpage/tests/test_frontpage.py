...
class TestFrontpage(TestCase, cradmin_testhelpers.TestCaseMixin):
    ...
    def test_title(self):
        ...
        self.assertEqual("Devilry frontpage", mockresponse.selector.one("title").alltext_normalized)

    def test_h1(self):
        testuser = baker.make(settings.AUTH_USER_MODEL)
        mockresponse = self.mock_http200_getrequest_htmls(requestuser=testuser)
        self.assertEqual("Choose your role", mockresponse.selector.one("h1").alltext_normalized)
    ...
    def test_user_is_student(self):
        ...
        mockresponse = self.mock_http200_getrequest_htmls(requestuser=testuser)
        self.assertTrue(mockresponse.selector.exists(".devilry-frontpage-listbuilder-roleselect-itemvalue-student"))
        self.assertFalse(mockresponse.selector.exists(".devilry-frontpage-listbuilder-roleselect-itemvalue-examiner"))
        self.assertFalse(mockresponse.selector.exists(".devilry-frontpage-listbuilder-roleselect-itemvalue-anyadmin"))
    ...
    def test_user_is_examiner(self):
        ...
        mockresponse = self.mock_http200_getrequest_htmls(requestuser=testuser)
        self.assertFalse(mockresponse.selector.exists(".devilry-frontpage-listbuilder-roleselect-itemvalue-student"))
        self.assertTrue(mockresponse.selector.exists(".devilry-frontpage-listbuilder-roleselect-itemvalue-examiner"))
        self.assertFalse(mockresponse.selector.exists(".devilry-frontpage-listbuilder-roleselect-itemvalue-anyadmin"))
    ...
    def test_user_is_superuser(self):
        ...
        self.assertFalse(mockresponse.selector.exists(".devilry-frontpage-listbuilder-roleselect-itemvalue-student"))
        self.assertFalse(mockresponse.selector.exists(".devilry-frontpage-listbuilder-roleselect-itemvalue-examiner"))
        self.assertTrue(mockresponse.selector.exists(".devilry-frontpage-listbuilder-roleselect-itemvalue-anyadmin"))
