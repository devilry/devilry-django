...
class TestEmailAuthBackend(TestCase):
    def setUp(self):
        self.testuser = User.objects.create_user(email="testuser@example.com", password="test")
    ...
    def test_authenticate(self):
        user = self.authbackend.authenticate(None, email="testuser@example.com", password="test")
        self.assertIsNotNone(user)
        self.assertEqual(self.testuser.pk, user.pk)

    def test_authenticate_invalid_password_returns_none(self):
        user = self.authbackend.authenticate(None, email="testuser@example.com", password="notcorrectpassword")
        self.assertIsNone(user)

    def test_authenticate_invalid_email_returns_none(self):
        user = self.authbackend.authenticate(None, email="doesnotexist@example.com", password="test")
        self.assertIsNone(user)


class TestUsernameAuthBackend(TestCase):
    def setUp(self):
        self.testuser = User.objects.create_user(username="testuser", password="test")
    ...
    def test_authenticate(self):
        user = self.authbackend.authenticate(None, username="testuser", password="test")
        self.assertIsNotNone(user)
        self.assertEqual(self.testuser.pk, user.pk)

    def test_authenticate_invalid_password_returns_none(self):
        user = self.authbackend.authenticate(None, username="testuser", password="notcorrectpassword")
        self.assertIsNone(user)

    def test_authenticate_invalid_email_returns_none(self):
        user = self.authbackend.authenticate(None, username="doesnotexist", password="test")
        self.assertIsNone(user)
