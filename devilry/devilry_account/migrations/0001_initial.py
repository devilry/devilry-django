    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('suspended_reason', models.TextField(default=b'', verbose_name='Reason for suspension', blank=True)),
                ('languagecode', models.CharField(default=b'', max_length=10, verbose_name='Preferred language', blank=True)),
            ],
            options={
                'verbose_name': 'User',
