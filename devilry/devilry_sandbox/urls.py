...
urlpatterns = [
    ...
    re_path("^createsubject-create$", CreateSubjectCreateView.as_view(), name="devilry-sandbox-createsubject-create"),
    re_path(
        "^createsubject-success/(?P<unique_number>\d+)$",
        CreateSubjectSuccessView.as_view(),
