...
def sync_cradmin_theme_into_devilry_theme(cradmin_root_dir):
    ...
    cradmin_lessdir = os.path.join(cradmin_root_dir, *'cradmin_legacy/static/cradmin_legacy/src/less'.split('/'))
...
def make_source_dist():
    ...
    local('git rm -r devilry/devilry_statistics/static/devilry_statistics/')
    local('ievv buildstatic --production --yarn-clean-node-modules')
    local('git add devilry/devilry_theme3/static/devilry_theme3/')
    local('git add devilry/devilry_statistics/static/devilry_statistics/')
