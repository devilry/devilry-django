...
class Command(BaseCommand):
    ...
    option_list = BaseCommand.option_list + (
        ...
        make_option("--minfiles", type="int", default=1, help="Minimum number of files per delivery. Defaults to 1."),
        make_option("--maxfiles", type="int", default=3, help="Maximum number of files per delivery. Defaults to 3."),
        make_option(
            "--mindeliveries", type="int", default=0, help="Minimum number of deliveries per delivery. Defaults to 0."
        ),
        make_option(
            "--maxdeliveries", type="int", default=3, help="Maximum number of deliveries per delivery. Defaults to 3."
        ),
    )
        ...
        for assignmentgroup in self.assignment.assignmentgroups.all().prefetch_related("candidates"):
            ...
            for deliverynumber in range(number_of_deliveries):
                ...
                for filepath in files:
                    ...
                    delivery.add_file(filename=filename, iterable_data=open(filepath, "rb"))
