...
CRADMIN_LEGACY_THEME_PATH = "devilry_theme3/{}/styles/cradmin_theme_devilry_mainpages/theme.css".format(
    devilry.__version__
)
CRADMIN_LEGACY_SUPERUSERUI_THEME_PATH = "devilry_theme3/{}/styles/cradmin_theme_devilry_superuserui/theme.css".format(
    devilry.__version__
)
