...
class TestStatus(test.TestCase):
    ...
    def test_notready_no_message(self):
        test_status = mommy.make('devilry_qualifiesforexam.Status', status=status_models.Status.NOTREADY)
    ...
    def test_ready_no_message_and_no_plugin(self):
        test_status = mommy.make('devilry_qualifiesforexam.Status', status=status_models.Status.READY)
    ...
    def test_get_current_status(self):
        ...
        mommy.make('devilry_qualifiesforexam.Status',
                   ...
                   plugin='plugin')
        last_status = mommy.make('devilry_qualifiesforexam.Status',
                                 period=testperiod,
                                 status=status_models.Status.READY,
                                 plugin='plugin')
