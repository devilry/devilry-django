    ...
    summaryTpl: [
        ...
        '<tpl else>',
            ...
            '<tpl if="status != \'notready\'">',
                ...
                '<tpl if="!plugin">',
                    '<p class="alert">',
                        gettext('This status was generated without a plugin. This means that the status was generated by {saveuser} using the programming interface for Devilry or imported by a system administrator. Only users with administrator-rights for the current timeperiod can set the status through the programming interface. This means that the lack of a plugin should not be a problem as long as the message (below) explains why a plugin was not used.'),
                    '</p>',
                '</tpl>',
            '</tpl>',
            '<tpl if="message">',
