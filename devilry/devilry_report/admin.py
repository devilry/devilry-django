...
class DevilryReportAdmin(admin.ModelAdmin):
    raw_id_fields = ["generated_by_user"]
    ...
    list_filter = ["status", "started_datetime", "finished_datetime", "generator_type"]

    search_fields = ["generated_by_user__id", "generated_by_user__fullname"]

    exclude = ["status_data", "generator_options"]
