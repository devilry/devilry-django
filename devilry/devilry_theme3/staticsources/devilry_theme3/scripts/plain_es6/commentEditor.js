...
class DevilryCommentEditor extends HTMLElement {
  ...
  _getNewPreviewSection () {
      if (!this.attrMarkdownPreviewConfig.enabled) {
          return '';
      }
      return `
      <div id="${this.elementId}_comment_editor_preview_section" class="devilry-comment-editor-preview"></div>
      `;
  }
  ...
  _getButtonTab () {
      ...
      <div class="tab">
          <button
              id="${this.elementId}_tab_button_write"
              class="tablinks active"
              type="button" disabled="true">
                  ${this.attrMarkdownPreviewConfig.editorActiveButtonText}
              </button>
          <button
              id="${this.elementId}_tab_button_preview"
              class="tablinks"
              type="button">
  ...
  renderEditor () {
      const commentEditor = new DOMParser().parseFromString(`
          <div aria-live="polite">
              ...
              <div id="${this.elementId}_tab_content_write" class="tabcontent" style="display:block;">
                  <div id="${this.elementId}_comment_editor_section" class="devilry-comment-editor">
                      ...
                      <label for="${this.elementId}" class="screenreader-only" aria-hidden="true">${this.attrLabelText}</label>
              ...
              <div id="${this.elementId}_tab_content_preview" class="tabcontent" style="display:none;">
                  ${this._getNewPreviewSection()}
              </div>
          <div>
  ...
  addTabEventListener () {
      ...
      const writeTabButton = document.getElementById(`${this.elementId}_tab_button_write`)
      const previewTabButton = document.getElementById(`${this.elementId}_tab_button_preview`)
      const writeTabContent = document.getElementById(`${this.elementId}_tab_content_write`);
      const previewTabContent = document.getElementById(`${this.elementId}_tab_content_preview`);
