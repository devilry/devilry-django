...
qualifiesforexam_plugins.add(
    ...
    description=_('Choose this option if you require your students to get a passing grade on all their '
                  'assignments to qualify for final exams.'),
...
qualifiesforexam_plugins.add(
    ...
    description=_('Choose this option if you require your students to get a passing grade on a subset'
                  ' of their assignments to qualify for final exams. You select the assignments on the next page.'),
