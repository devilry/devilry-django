...
class TestExaminerTriggers(test.TestCase):
    ...
    def test_insert_history_models_fields_multiple(self):
        ...
        baker.make("core.Examiner", assignmentgroup=testgroup1, relatedexaminer__user=testuser1)

        testgroup2 = baker.make("core.AssignmentGroup")
        testuser2 = baker.make(settings.AUTH_USER_MODEL)
        baker.make("core.Examiner", assignmentgroup=testgroup2, relatedexaminer__user=testuser2)
