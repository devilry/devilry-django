        ...
        out.append(
            (
                "delivery_time_descending",
                {
                    ...
                    "order_by": ["-assignmentgroups__cached_data__last_feedbackset__created_datetime"],
                },
            ),
        )
        return out
...
class AssignmentCheckboxFilter(listfilter.basefilters.multi.abstractcheckbox.AbstractCheckboxFilter):
    ...
    def filter(self, queryobject):
        ...
        if cleaned_value == "has-delivery":
            out = queryobject.exclude(
                assignmentgroups__feedbackset__groupcomment__visibility=GroupComment.VISIBILITY_PRIVATE
