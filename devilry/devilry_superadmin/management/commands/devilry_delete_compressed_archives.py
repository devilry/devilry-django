...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            "--deleted", action="store_true", default=False, help="Delete all compressed archives marked as deleted."
        )
        parser.add_argument("--all", action="store_true", default=False, help="Delete all compressed archives.")
    ...
    def handle(self, *args, **options):
        ...
        if (delete_all and num_days) or (delete_all and num_seconds) or (num_days and num_seconds):
