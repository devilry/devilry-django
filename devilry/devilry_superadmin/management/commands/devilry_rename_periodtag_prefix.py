...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument("tag_prefix_old", help="The prefix to replace.")
        parser.add_argument("tag_prefix_new", help="The prefix to update period tags with.")
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(
            "Updating prefix from '{}' to '{}' for {} period tags".format(
                tag_prefix_old, tag_prefix_new, periodtag_queryset.count()
            )
        )
