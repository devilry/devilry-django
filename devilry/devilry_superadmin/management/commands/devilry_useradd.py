...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        (
            parser.add_argument(
                "username_v2_compat", default="", help="Username. Alias for --username for devilry v2 compatibility."
            ),
        )
        (
            parser.add_argument(
                ...
                dest="username",
                default="",
                help="Username. Must be specified if you use usernames for authentication.",
            ),
        )
        (
            parser.add_argument(
                ...
                dest="email",
                default="",
                help="Email address. Must be specified if you use emails for authentication",
            ),
        )
        (parser.add_argument("--full_name", dest="full_name", default="", help="Full name"),)
        (
            parser.add_argument(
                "--superuser",
                action="store_true",
