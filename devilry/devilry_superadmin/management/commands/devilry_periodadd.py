...
class Command(RecordSaveModCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument("subject_short_name", help="Short name of the subject to add the period within.")
        parser.add_argument("period_short_name", help="Short name of the period you want to create.")
        (
            parser.add_argument(
                "--long-name", dest="long_name", default=None, required=True, help="Long name of period (Required)"
            ),
        )
        (
            parser.add_argument(
