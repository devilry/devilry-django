...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        (parser.add_argument("short_name", help="Short name for the subject. (Required)"),)
        parser.add_argument("group_name", help="Name of the permission group. (Required)")
    ...
    def handle(self, *args, **options):
        ...
        subject_permission_group = SubjectPermissionGroup(subject=subject, permissiongroup=permission_group)
