...
class TestPeriodadminclearCommand(test.TestCase):
    def __run_management_command(self, subject_short_name, period_short_name):
        management.call_command("devilry_periodadminclear", subject_short_name, period_short_name)
    ...
    def test_invalid_subject_short_name(self):
        ...
        with self.assertRaisesMessage(CommandError, "Invalid subject_short_name."):
            self.__run_management_command(subject_short_name="invalid", period_short_name="testperiod")
    ...
    def test_invalid_period_short_name(self):
        ...
        with self.assertRaisesMessage(CommandError, "Invalid period_short_name."):
            self.__run_management_command(subject_short_name="testsubject", period_short_name="invalid")
    ...
    def test_ok_no_permissiongroup(self):
        ...
        self.__run_management_command(subject_short_name="testsubject", period_short_name="testperiod")
        self.assertEqual(PermissionGroup.objects.count(), 0)
    ...
    def test_ok_existing_permission_group(self):
        ...
        baker.make("devilry_account.PeriodPermissionGroup", permissiongroup=permissiongroup, period=period)
