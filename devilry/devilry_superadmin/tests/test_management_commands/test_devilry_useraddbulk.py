...
class TestUseraddbulkCommand(test.TestCase):
    def __run_management_command(self, *username_or_email):
        management.call_command("devilry_useraddbulk", *username_or_email)
    ...
    @override_settings(CRADMIN_LEGACY_USE_EMAIL_AUTH_BACKEND=False, DEVILRY_DEFAULT_EMAIL_USERNAME_SUFFIX="example.com")
