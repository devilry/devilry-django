...
class TestSubjectadminaddCommand(test.TestCase):
    def __run_management_command(self, subject_short_name, user_shortname):
        management.call_command("devilry_subjectadminadd", subject_short_name, user_shortname)
    ...
    def test_invalid_subject_short_name(self):
        ...
        with self.assertRaisesMessage(CommandError, "Invalid subject_short_name."):
            self.__run_management_command(subject_short_name="invalid", user_shortname="testuser")
    ...
    def test_invalid_user_shortname(self):
        ...
        with self.assertRaisesMessage(CommandError, "Invalid user_shortname."):
            self.__run_management_command(subject_short_name="testsubject", user_shortname="invalid")
    ...
    def test_ok_new_permission_group(self):
        ...
        self.__run_management_command(subject_short_name="testsubject", user_shortname="testuser")
        ...
        self.assertEqual(created_subject_permissiongroup.permissiongroup, created_permissiongroup)
