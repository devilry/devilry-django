    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('staticfeedback', models.OneToOneField(related_name='devilry_gradingsystem_feedbackdraft_set', null=True, blank=True, to='core.StaticFeedback', help_text='The StaticFeedback where this was published if this draft has been published.')),
            ],
            options={
