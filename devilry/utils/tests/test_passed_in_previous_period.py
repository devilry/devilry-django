...
class TestPassedInPreviousPeriodQueryset(TestCase):
    ...
    def test_lol(self):
        ...
        candidate_duck1010 = baker.make(
            "core.Candidate",
            assignment_group=group_duck1010,
            relatedstudent__period=period_duck1010,
            relatedstudent__user=user_april,
        )
        ...
        candidate_april_duck1100 = baker.make(
            "core.Candidate",
            assignment_group=group1_duck1100,
            relatedstudent__period=period_duck1100,
            relatedstudent__user=user_april,
        )
        candidate_dewey_duck1100 = baker.make(
            "core.Candidate",
            assignment_group=group2_duck1100,
            relatedstudent__period=period_duck1100,
            relatedstudent__user=user_dewey,
        )
        ...
        period_duck1010_current = baker.make(
            "core.Period",
        ...
        candidate_duck1010_current = baker.make(
            "core.Candidate",
            assignment_group=group_duck1010_current,
            relatedstudent__period=period_duck1010_current,
            relatedstudent__user=user_april,
        )

        passed_in_previous_queryset = PassedInPreviousPeriod(
            assignment=assignment_duck1010_current, from_period=assignment_duck1010.parentnode
        ).get_queryset()
    ...
    def test_from_period_older_is_ignored(self):
        ...
        baker.make(
            "core.Candidate", assignment_group=current_group1, relatedstudent__user=candidate1.relatedstudent.user
        )
        current_group2 = baker.make("core.AssignmentGroup", parentnode=current_assignment)
        baker.make(
            "core.Candidate", assignment_group=current_group2, relatedstudent__user=candidate2.relatedstudent.user
        )
        current_group3 = baker.make("core.AssignmentGroup", parentnode=current_assignment)
        baker.make(
            "core.Candidate", assignment_group=current_group3, relatedstudent__user=candidate3.relatedstudent.user
        )
    ...
    def test_no_one_passed_in_pervious_period(self):
        assignment1 = baker.make_recipe(
            "devilry.apps.core.assignment_oldperiod_start", short_name="Cool", passing_grade_min_points=5
        )
        ...
        assignment2 = baker.make_recipe(
            "devilry.apps.core.assignment_activeperiod_start", short_name="Cool", passing_grade_min_points=5
        )
        ...
        current_assignment = baker.make_recipe(
            "devilry.apps.core.assignment_futureperiod_start", short_name="Cool", passing_grade_min_points=5
        )
        current_group1 = baker.make("core.AssignmentGroup", parentnode=current_assignment)
        baker.make(
            "core.Candidate", assignment_group=current_group1, relatedstudent__user=candidate1.relatedstudent.user
    ...
    def test_candidates_who_got_graded_on_current_assignment_is_filtered_away(self):
        ...
        self.assertEqual(
            candidate_queryset.first().relatedstudent.user.get_displayname(),
...
class TestPassedInPreviousPeriodPointConverter(TestCase):
    ...
    def test_point_converter_1(self):
        assignment1 = baker.make_recipe(
            "devilry.apps.core.assignment_oldperiod_start", short_name="Cool", passing_grade_min_points=6, max_points=10
        )
        ...
        assignment2 = baker.make_recipe(
            "devilry.apps.core.assignment_oldperiod_start", short_name="Cool", passing_grade_min_points=2, max_points=5
        )
    ...
    def test_point_converter_2(self):
        assignment1 = baker.make_recipe(
            "devilry.apps.core.assignment_oldperiod_start", short_name="Cool", passing_grade_min_points=3, max_points=5
        )
        group = baker.make("core.AssignmentGroup", parentnode=assignment1)
    ...
    def test_point_converter_3(self):
        assignment1 = baker.make_recipe(
            "devilry.apps.core.assignment_oldperiod_start", short_name="Cool", passing_grade_min_points=2, max_points=3
        )
        group = baker.make("core.AssignmentGroup", parentnode=assignment1)
        feedbackset = group_baker.feedbackset_first_attempt_published(group=group, grading_points=3)
    ...
    def test_point_converter_4(self):
        assignment1 = baker.make_recipe(
            "devilry.apps.core.assignment_oldperiod_start", short_name="Cool", passing_grade_min_points=1, max_points=1
        )
        group = baker.make("core.AssignmentGroup", parentnode=assignment1)
...
class TestPassedInPreviousPeriod(TestCase):
    ...
    def test_simple(self):
        ...
        baker.make(
            "core.Candidate", assignment_group=current_group, relatedstudent__user=candidate1.relatedstudent.user
        )
        ...
        published_feedbackset = AssignmentGroup.objects.get(id=current_group.id).cached_data.last_published_feedbackset
    ...
    def test_multiple_candidates(self):
        ...
        baker.make(
            "core.Candidate", assignment_group=current_groups[0], relatedstudent__user=candidate1.relatedstudent.user
        )
        current_groups.append(baker.make("core.AssignmentGroup", parentnode=current_assignment, name="current_group1"))
        baker.make(
            "core.Candidate", assignment_group=current_groups[1], relatedstudent__user=candidate2.relatedstudent.user
        )
        current_groups.append(baker.make("core.AssignmentGroup", parentnode=current_assignment, name="current_group1"))
        baker.make(
            "core.Candidate", assignment_group=current_groups[2], relatedstudent__user=candidate3.relatedstudent.user
        )
        ...
        for new_feedbackset, prev_feedbackset in zip(published_feedbacksets, previous_feedbacksets):
            self.assertIsNotNone(FeedbacksetPassedPreviousPeriod.objects.filter(feedbackset=new_feedbackset).first())
            ...
            self.assertEqual(new_feedbackset.grading_points, passed_in_previous.convert_points(prev_feedbackset))
    ...
    def test_a_selected_student_has_never_done_the_previous_assignment(self):
        ...
        assignment2 = baker.make_recipe(
            "devilry.apps.core.assignment_oldperiod_start", parentnode=assignment.parentnode, short_name="imba"
        )
