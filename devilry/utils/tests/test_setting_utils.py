...
class TestHardDeadlineInfoTextSettingUtil(test.TestCase):
    @override_settings(DEVILRY_INFO_TEXT_TEST={})
    def test_get_devilry_hard_deadline_info_text_no_default(self):
        with self.assertRaisesMessage(
            ValueError,
            "User error: The DEVILRY_INFO_TEXT_TEST must contain a '__default' "
    ...
    @override_settings(DEVILRY_INFO_TEXT_TEST={"__default": "Default info text"})
    ...
    @override_settings(DEVILRY_INFO_TEXT_TEST={"__default": "Default info text", "en": "English info text"})
