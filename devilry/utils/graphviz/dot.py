...
class UmlClassLabel(object):
    ...
    headrow_tpl = (
        '  <TR><TD bgcolor="#222222" align="CENTER"><FONT COLOR="#ffffff" point-size="12">%s</FONT></TD></TR>\n'
    )
...
class Edge(object):
    def __init__(self, taillabel="", headlabel="", label="", arrowhead="none", color="#777777"):
...
%(graphtype)s G {
    ...
    def __str__(self):
        return self.tpl % dict(size=self.size, graphtype=self.graphtype, items="\n\n    ".join(self.stritems()))
