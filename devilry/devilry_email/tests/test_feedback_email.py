...
class TestFeedbackEmail(test.TestCase):
    ...
    def __setup_feedback_set(self, deadline_datetime=None, grading_published_datetime=None):
        ...
        testassignment = baker.make_recipe(
            ...
            parentnode__parentnode__long_name="Subject 1",
        )
    ...
    def test_send_feedback_email_subject(self):
        ...
        self.assertEqual(
            mail.outbox[0].subject, "[Devilry] Feedback for {}".format(test_feedbackset.group.parentnode.long_name)
        )
    ...
    def test_send_feedback_email_body_result(self):
        ...
        self.assertEqual(
            htmls.S(mail.outbox[0].message().as_string()).one(".devilry_email_feedback_result").alltext_normalized,
            "Result: 1/1 ( passed )",
        )
    ...
    def test_send_feedback_email_body_corrected_datetime(self):
        ...
        self.assertEqual(
            ...
            .one(".devilry_email_feedback_corrected_datetime")
            .alltext_normalized,
    ...
    def test_send_feedback_email_body_deadline_datetime(self):
        ...
        self.assertEqual(
            htmls.S(mail.outbox[0].message().as_string())
            .one(".devilry_email_feedback_deadline_datetime")
            .alltext_normalized,
    ...
    def test_send_feedback_email_body_assignment(self):
        ...
        self.assertEqual(
            htmls.S(mail.outbox[0].message().as_string()).one(".devilry_email_feedback_assignment").alltext_normalized,
    ...
    def test_send_feedback_email_body_subject(self):
        ...
        self.assertEqual(
            htmls.S(mail.outbox[0].message().as_string()).one(".devilry_email_feedback_subject").alltext_normalized,
    ...
    def test_send_feedback_email_body_link(self):
        ...
        self.assertEqual(
            htmls.S(mail.outbox[0].message().as_string()).one(".devilry_email_feedback_detail_url").alltext_normalized,
            feedback_link,
        )
