...
registry.register_normal(DashboardItem(
         ...
         admin_access=True,
         js = [reverse('admin-autocomplete-nodename.js')]
))
...
registry.register_normal(DashboardItem(
         ...
         admin_access=True,
         js = [reverse('admin-autocomplete-subjectname.js')]
))
...
registry.register_normal(DashboardItem(
         ...
         admin_access=True,
         js = [reverse('admin-autocomplete-periodname.js')]
))
...
registry.register_important(DashboardItem(
         ...
         admin_access=True,
         js = [reverse('admin-autocomplete-assignmentname.js')]
))
