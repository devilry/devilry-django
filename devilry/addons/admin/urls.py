...
urlpatterns = patterns('devilry.addons.admin',
    ...
    url(r'^assignments/(?P<assignment_id>\d+)/download_file_collection$',
        'views.assignmentgroup.download_file_collection_as_tar',
        name='devilry-admin-download_file_collection_as_tar'),
    url(r'^assignments/(?P<assignment_id>\d+)/download_file_collection$',
        'views.assignmentgroup.download_file_collection_as_zip',
        name='devilry-admin-download_file_collection_as_zip'),
