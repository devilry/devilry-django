...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AssignmentGroup.last_deadline'
        db.add_column('core_assignmentgroup', 'last_deadline',
                      self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='last_deadline_for_group', unique=True, null=True, to=orm['core.Deadline']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AssignmentGroup.last_deadline'
        db.delete_column('core_assignmentgroup', 'last_deadline_id')
