...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AssignmentGroup.delivery_status'
        db.add_column('core_assignmentgroup', 'delivery_status',
                      self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AssignmentGroup.delivery_status'
        db.delete_column('core_assignmentgroup', 'delivery_status')
