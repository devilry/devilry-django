                    ...
                    '<div class="devilry_focuscontainer" style="padding: 20px; margin-bottom: 20px;">',
                      ...
                      '<tpl for="periods">',
                          ...
                          '<tpl if="is_relatedstudent">',
                              '<span class="label label-success">', gettext('Registred as student on period'), '</span>',
                          '<tpl else>',
                              '<span class="label label-important">', gettext('Not registred as student on period'), '</span>',
                          '</tpl>',
