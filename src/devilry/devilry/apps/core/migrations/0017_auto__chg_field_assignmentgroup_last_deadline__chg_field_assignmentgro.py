...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AssignmentGroup.last_deadline'
        db.alter_column('core_assignmentgroup', 'last_deadline_id', self.gf('django.db.models.fields.related.OneToOneField')(null=True, on_delete=models.SET_NULL, to=orm['core.Deadline'], unique=True))

        # Changing field 'AssignmentGroup.last_delivery'
        db.alter_column('core_assignmentgroup', 'last_delivery_id', self.gf('django.db.models.fields.related.OneToOneField')(null=True, on_delete=models.SET_NULL, to=orm['core.Delivery'], unique=True))

    def backwards(self, orm):

        # Changing field 'AssignmentGroup.last_deadline'
        db.alter_column('core_assignmentgroup', 'last_deadline_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['core.Deadline']))

        # Changing field 'AssignmentGroup.last_delivery'
        db.alter_column('core_assignmentgroup', 'last_delivery_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['core.Delivery']))
