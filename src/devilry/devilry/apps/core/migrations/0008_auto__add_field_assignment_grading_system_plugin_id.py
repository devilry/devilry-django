...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Assignment.grading_system_plugin_id'
        db.add_column('core_assignment', 'grading_system_plugin_id',
                      self.gf('django.db.models.fields.CharField')(max_length=300, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Assignment.grading_system_plugin_id'
        db.delete_column('core_assignment', 'grading_system_plugin_id')
