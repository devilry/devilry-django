...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Delivery.last_feedback'
        db.add_column('core_delivery', 'last_feedback',
                      self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='latest_feedback_for_delivery', unique=True, null=True, to=orm['core.StaticFeedback']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Delivery.last_feedback'
        db.delete_column('core_delivery', 'last_feedback_id')
