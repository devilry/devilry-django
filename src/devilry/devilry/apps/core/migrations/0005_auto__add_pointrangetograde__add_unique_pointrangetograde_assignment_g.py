...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'PointRangeToGrade', fields ['assignment', 'grade']
        db.create_unique('core_pointrangetograde', ['assignment_id', 'grade'])
    ...
    def backwards(self, orm):
        # Removing unique constraint on 'PointRangeToGrade', fields ['assignment', 'grade']
        db.delete_unique('core_pointrangetograde', ['assignment_id', 'grade'])
    ...
    models = {
        ...
        'core.pointrangetograde': {
            'Meta': {'ordering': "['minimum_points']", 'unique_together': "(('assignment', 'grade'),)", 'object_name': 'PointRangeToGrade'},
