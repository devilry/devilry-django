...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PointToGradeMap.invalid'
        db.add_column('core_pointtogrademap', 'invalid',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PointToGradeMap.invalid'
        db.delete_column('core_pointtogrademap', 'invalid')
