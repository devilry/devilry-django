...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('core_assignmentgroup', 'last_delivery',
                      self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='last_delivery_by_group', unique=True, null=True, to=orm['core.Delivery']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AssignmentGroup.last_delivery'
        db.delete_column('core_assignmentgroup', 'last_delivery_id')
