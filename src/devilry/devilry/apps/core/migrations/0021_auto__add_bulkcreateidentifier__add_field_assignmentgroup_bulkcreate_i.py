...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BulkCreateIdentifier'
        db.create_table('core_bulkcreateidentifier', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('core', ['BulkCreateIdentifier'])

        # Adding field 'AssignmentGroup.bulkcreate_identifier'
        db.add_column('core_assignmentgroup', 'bulkcreate_identifier',
                      self.gf('devilry.apps.core.models.bulkcreateidentifier.BulkCreateIdentifierField')(blank=True, related_name='+', null=True, on_delete=models.SET_NULL, to=orm['core.BulkCreateIdentifier']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'BulkCreateIdentifier'
        db.delete_table('core_bulkcreateidentifier')

        # Deleting field 'AssignmentGroup.bulkcreate_identifier'
        db.delete_column('core_assignmentgroup', 'bulkcreate_identifier_id')
    ...
    models = {
        ...
        'core.assignmentgroup': {
            ...
            'bulkcreate_identifier': ('devilry.apps.core.models.bulkcreateidentifier.BulkCreateIdentifierField', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': "orm['core.BulkCreateIdentifier']"}),
        ...
        'core.bulkcreateidentifier': {
            'Meta': {'ordering': "['timestamp']", 'object_name': 'BulkCreateIdentifier'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
