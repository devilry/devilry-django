...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PointToGradeMap'
        db.create_table('core_pointtogrademap', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('assignment', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['core.Assignment'], unique=True)),
        ))
        db.send_create_signal('core', ['PointToGradeMap'])

        # Adding model 'PointRangeToGrade'
        db.create_table('core_pointrangetograde', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('point_to_grade_map', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.PointToGradeMap'])),
            ('minimum_points', self.gf('django.db.models.fields.IntegerField')()),
            ('maximum_points', self.gf('django.db.models.fields.IntegerField')()),
            ('grade', self.gf('django.db.models.fields.CharField')(max_length=12)),
        ))
        db.send_create_signal('core', ['PointRangeToGrade'])

        # Adding unique constraint on 'PointRangeToGrade', fields ['point_to_grade_map', 'grade']
        db.create_unique('core_pointrangetograde', ['point_to_grade_map_id', 'grade'])

        # Adding field 'Assignment.max_points'
        db.add_column('core_assignment', 'max_points',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Assignment.passing_grade_min_points'
        db.add_column('core_assignment', 'passing_grade_min_points',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Assignment.points_to_grade_mapper'
        db.add_column('core_assignment', 'points_to_grade_mapper',
                      self.gf('django.db.models.fields.CharField')(default='passed-failed', max_length=25, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'PointRangeToGrade', fields ['point_to_grade_map', 'grade']
        db.delete_unique('core_pointrangetograde', ['point_to_grade_map_id', 'grade'])

        # Deleting model 'PointToGradeMap'
        db.delete_table('core_pointtogrademap')

        # Deleting model 'PointRangeToGrade'
        db.delete_table('core_pointrangetograde')

        # Deleting field 'Assignment.max_points'
        db.delete_column('core_assignment', 'max_points')

        # Deleting field 'Assignment.passing_grade_min_points'
        db.delete_column('core_assignment', 'passing_grade_min_points')

        # Deleting field 'Assignment.points_to_grade_mapper'
        db.delete_column('core_assignment', 'points_to_grade_mapper')
    ...
    models = {
        ...
        'core.assignment': {
            ...
            'passing_grade_min_points': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
        ...
        'core.pointrangetograde': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'maximum_points': ('django.db.models.fields.IntegerField', [], {}),
