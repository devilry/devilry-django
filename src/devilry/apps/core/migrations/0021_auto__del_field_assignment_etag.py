...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Assignment.etag'
        db.delete_column(u'core_assignment', 'etag')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Assignment.etag'
        raise RuntimeError("Cannot reverse this migration. 'Assignment.etag' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Assignment.etag'
        db.add_column(u'core_assignment', 'etag',
