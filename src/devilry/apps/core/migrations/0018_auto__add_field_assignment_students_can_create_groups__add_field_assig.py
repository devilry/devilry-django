...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Assignment.students_can_create_groups'
        db.add_column('core_assignment', 'students_can_create_groups',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Assignment.students_can_not_create_groups_after'
        db.add_column('core_assignment', 'students_can_not_create_groups_after',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Assignment.students_can_create_groups'
        db.delete_column('core_assignment', 'students_can_create_groups')

        # Deleting field 'Assignment.students_can_not_create_groups_after'
        db.delete_column('core_assignment', 'students_can_not_create_groups_after')
