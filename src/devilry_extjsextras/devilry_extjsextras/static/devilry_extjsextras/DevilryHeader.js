 ...
 */
Ext.define('devilry_extjsextras.DevilryHeader', {
            ...
            '<div class="nav {navclass}">',
                '<ul>',
                    ...
                    '<li class="externallink-navitem"><a href="{DevilrySettings.DEVILRY_HELP_URL}" target="_blank">',
                        dtranslate('devilry_extjsextras.helplink.title'),
                    '</a></li>',
                '</ul>',
            '</div>',
        '</div>'
