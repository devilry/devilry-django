...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UploadedDeliveryFile'
        db.create_table('devilry_student_uploadeddeliveryfile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('deadline', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Deadline'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('uploaded_datetime', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('uploaded_file', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
            ('filename', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('devilry_student', ['UploadedDeliveryFile'])

        # Adding unique constraint on 'UploadedDeliveryFile', fields ['deadline', 'user', 'filename']
        db.create_unique('devilry_student_uploadeddeliveryfile', ['deadline_id', 'user_id', 'filename'])


    def backwards(self, orm):
        # Removing unique constraint on 'UploadedDeliveryFile', fields ['deadline', 'user', 'filename']
        db.delete_unique('devilry_student_uploadeddeliveryfile', ['deadline_id', 'user_id', 'filename'])

        # Deleting model 'UploadedDeliveryFile'
        db.delete_table('devilry_student_uploadeddeliveryfile')
    ...
    models = {
        ...
        'devilry_student.uploadeddeliveryfile': {
            'Meta': {'unique_together': "(('deadline', 'user', 'filename'),)", 'object_name': 'UploadedDeliveryFile'},
            'deadline': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Deadline']"}),
            'filename': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'uploaded_datetime': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'uploaded_file': ('django.db.models.fields.files.FileField', [], {'max_length': '100'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        }
    }

    complete_apps = ['devilry_student']