            ...
            items: [{
                ...
                items: [{
                    ...
                    tpl: [
                        ...
                        '<p>', gettext('Each {subject_term} in the list below has one of the following statuses:'), '</p>',
                        '<dl>',
                        ...
                        '<dl>',
                            ...
                            '<dd>', gettext('The {subject} administrator has not selected students that qualify for final exams yet.'), '</dd>',
                        '<dl>',
                        '<dl>',
                            '<dt><span class="text-warning">', gettext('Not ready for export (retracted)'), '</span></dt>',
                            '<dd>',
                                gettext('The subject administrator has retracted a previously "Ready for export" status. This may be bad if you have already exported the status.'),
                            '</dd>',
                        '<dl>',
