        ...
        html: [
            '<div class="alert alert-info">',
                ...
                '<dl>',
                    ...
                    '<dd>',
                        gettext('Any grade in Devilry is represented as a number. This number is used for statistics and to calculate final grades. Points is not available directly to students, but some grade editors make them available through the <em>Short text</em> (below).'),
                    '</dd>',
                    ...
                    '<dd>',
                        gettext('A longer text that students can view. This is usually the detailed feedback text, however some grade editors also fill this with autogenerated information based on input from examiners. What a grade editor can display in the long text is virtually unlimited.'),
                    '</dd>',
                '</ul>',
            '</div>'
        ].join('')
