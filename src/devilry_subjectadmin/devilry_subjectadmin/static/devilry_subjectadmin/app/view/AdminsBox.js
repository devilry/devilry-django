    ...
    adminsTpl: [
        ...
        '<div {MORE_ATTRS}>',
            ...
            '<tpl if="inherited_admins.length &gt; 0">',
                ...
                '<p><small class="muted">',
                    gettext('These administrators are from items higher up in the hierarchy. The links in parenthesis is to the location where the administrator propagates from.'),
                '</small></p>',
