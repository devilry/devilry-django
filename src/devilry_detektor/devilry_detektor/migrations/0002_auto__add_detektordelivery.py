...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DetektorDelivery'
        db.create_table('devilry_detektor_detektordelivery', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('detektorassignment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['devilry_detektor.DetektorAssignment'])),
            ('delivery', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['core.Delivery'], unique=True)),
            ('keywordstring', self.gf('django.db.models.fields.TextField')()),
            ('operatorstring', self.gf('django.db.models.fields.TextField')()),
            ('bigstring', self.gf('django.db.models.fields.TextField')()),
            ('bigstringhash', self.gf('django.db.models.fields.TextField')()),
            ...
            ('list_of_functions', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('devilry_detektor', ['DetektorDelivery'])


    def backwards(self, orm):
        # Deleting model 'DetektorDelivery'
        db.delete_table('devilry_detektor_detektordelivery')
    ...
    models = {
        ...
        'devilry_detektor.detektordelivery': {
            'Meta': {'object_name': 'DetektorDelivery'},
            'bigstring': ('django.db.models.fields.TextField', [], {}),
            'bigstringhash': ('django.db.models.fields.TextField', [], {}),
            'delivery': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['core.Delivery']", 'unique': 'True'}),
            'detektorassignment': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['devilry_detektor.DetektorAssignment']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'keywordstring': ('django.db.models.fields.TextField', [], {}),
            'list_of_functions': ('django.db.models.fields.TextField', [], {}),
            'number_of_keywords': ('django.db.models.fields.IntegerField', [], {}),
            'number_of_operators': ('django.db.models.fields.IntegerField', [], {}),
            'operatorstring': ('django.db.models.fields.TextField', [], {})
        }
    }
