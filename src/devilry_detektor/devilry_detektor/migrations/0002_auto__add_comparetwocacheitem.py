...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('devilry_detektor_comparetwocacheitem', (
            ...
            ('detektorassignment', self.gf('django.db.models.fields.related.ForeignKey')(related_name='comparetwo_cacheitems', to=orm['devilry_detektor.DetektorAssignment'])),
    ...
    models = {
        ...
        'devilry_detektor.comparetwocacheitem': {
            ...
            'detektorassignment': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'comparetwo_cacheitems'", 'to': "orm['devilry_detektor.DetektorAssignment']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
